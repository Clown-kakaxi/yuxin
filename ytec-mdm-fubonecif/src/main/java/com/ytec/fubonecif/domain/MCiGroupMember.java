...
/**
 * The persistent class for the M_CI_GROUP_MEMBER database table.
 * 
 */
@Entity
@Table(name="M_CI_GROUP_MEMBER")
public class MCiGroupMember implements Serializable {
