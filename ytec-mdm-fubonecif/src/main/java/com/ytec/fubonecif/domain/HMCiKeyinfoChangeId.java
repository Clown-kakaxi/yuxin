...
/**
 * HMCiKeyinfoChangeId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiKeyinfoChangeId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiKeyinfoChangeId() {
	}

	/** minimal constructor */
	public HMCiKeyinfoChangeId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiKeyinfoChangeId(String changeId, String custId,
			String changeType, String infoName, String beforeInfo,
			String afterInfo, Date changeDate, Timestamp changeTime,
	...
	@Column(name = "CHANGE_ID", length = 20)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiKeyinfoChangeId))
			return false;
		HMCiKeyinfoChangeId castOther = (HMCiKeyinfoChangeId) other;

		return ((this.getChangeId() == castOther.getChangeId()) || (this
				.getChangeId() != null
				&& castOther.getChangeId() != null && this.getChangeId()
				.equals(castOther.getChangeId())))
				...
				&& ((this.getInfoName() == castOther.getInfoName()) || (this
						.getInfoName() != null
						&& castOther.getInfoName() != null && this
						.getInfoName().equals(castOther.getInfoName())))
				&& ((this.getBeforeInfo() == castOther.getBeforeInfo()) || (this
						.getBeforeInfo() != null
						&& castOther.getBeforeInfo() != null && this
						.getBeforeInfo().equals(castOther.getBeforeInfo())))
				&& ((this.getAfterInfo() == castOther.getAfterInfo()) || (this
						.getAfterInfo() != null
						&& castOther.getAfterInfo() != null && this
						.getAfterInfo().equals(castOther.getAfterInfo())))
				...
				&& ((this.getChangeTime() == castOther.getChangeTime()) || (this
						.getChangeTime() != null
						&& castOther.getChangeTime() != null && this
						.getChangeTime().equals(castOther.getChangeTime())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getChangeId() == null ? 0 : this.getChangeId().hashCode());
		result = 37 * result
		...
		result = 37
				* result
				+ (getChangeType() == null ? 0 : this.getChangeType()
						.hashCode());
		result = 37 * result
				+ (getInfoName() == null ? 0 : this.getInfoName().hashCode());
		result = 37
				* result
				+ (getBeforeInfo() == null ? 0 : this.getBeforeInfo()
						.hashCode());
		result = 37 * result
				+ (getAfterInfo() == null ? 0 : this.getAfterInfo().hashCode());
		result = 37
				* result
		...
		result = 37
				* result
				+ (getChangeTime() == null ? 0 : this.getChangeTime()
						.hashCode());
		result = 37
				* result
