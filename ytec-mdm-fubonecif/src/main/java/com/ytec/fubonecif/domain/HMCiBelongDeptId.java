...
/**
 * HMCiBelongDeptId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiBelongDeptId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiBelongDeptId() {
	}

	/** minimal constructor */
	public HMCiBelongDeptId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiBelongDeptId(String belongDeptId, String custId,
			String belongDept, String lastUpdateSys, String lastUpdateUser,
	...
	@Column(name = "BELONG_DEPT_ID", length = 20)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiBelongDeptId))
			return false;
		HMCiBelongDeptId castOther = (HMCiBelongDeptId) other;

		return ((this.getBelongDeptId() == castOther.getBelongDeptId()) || (this
				.getBelongDeptId() != null
				&& castOther.getBelongDeptId() != null && this
				.getBelongDeptId().equals(castOther.getBelongDeptId())))
				&& ((this.getCustId() == castOther.getCustId()) || (this
						.getCustId() != null
						&& castOther.getCustId() != null && this.getCustId()
						.equals(castOther.getCustId())))
				&& ((this.getBelongDept() == castOther.getBelongDept()) || (this
						.getBelongDept() != null
						&& castOther.getBelongDept() != null && this
						.getBelongDept().equals(castOther.getBelongDept())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBelongDeptId() == null ? 0 : this.getBelongDeptId()
						.hashCode());
		result = 37 * result
				+ (getCustId() == null ? 0 : this.getCustId().hashCode());
		result = 37
				* result
				+ (getBelongDept() == null ? 0 : this.getBelongDept()
						.hashCode());
		result = 37
				* result
