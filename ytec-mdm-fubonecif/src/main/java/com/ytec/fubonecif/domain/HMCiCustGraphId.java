...
/**
 * HMCiCustGraphId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiCustGraphId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiCustGraphId() {
	}

	/** minimal constructor */
	public HMCiCustGraphId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiCustGraphId(String graphId, String graphName, String graphDesc,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiCustGraphId))
			return false;
		HMCiCustGraphId castOther = (HMCiCustGraphId) other;

		return ((this.getGraphId() == castOther.getGraphId()) || (this
				.getGraphId() != null
				&& castOther.getGraphId() != null && this.getGraphId().equals(
				castOther.getGraphId())))
				&& ((this.getGraphName() == castOther.getGraphName()) || (this
						.getGraphName() != null
						&& castOther.getGraphName() != null && this
						.getGraphName().equals(castOther.getGraphName())))
				&& ((this.getGraphDesc() == castOther.getGraphDesc()) || (this
						.getGraphDesc() != null
						&& castOther.getGraphDesc() != null && this
						.getGraphDesc().equals(castOther.getGraphDesc())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getGraphName() == null ? 0 : this.getGraphName().hashCode());
		result = 37 * result
				+ (getGraphDesc() == null ? 0 : this.getGraphDesc().hashCode());
		result = 37
				* result
