...
/**
 * HMCiCustVertexId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiCustVertexId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiCustVertexId() {
	}

	/** minimal constructor */
	public HMCiCustVertexId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiCustVertexId(String vertexId, String graphId, String custId,
	...
	@Column(name = "VERTEX_ID", length = 20)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiCustVertexId))
			return false;
		HMCiCustVertexId castOther = (HMCiCustVertexId) other;

		return ((this.getVertexId() == castOther.getVertexId()) || (this
				.getVertexId() != null
				&& castOther.getVertexId() != null && this.getVertexId()
				.equals(castOther.getVertexId())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVertexId() == null ? 0 : this.getVertexId().hashCode());
		result = 37 * result
