...
/**
 * HMCiBelongManagerId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiBelongManagerId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiBelongManagerId() {
	}

	/** minimal constructor */
	public HMCiBelongManagerId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiBelongManagerId(String belongManagerId, String custId,
	...
	@Column(name = "BELONG_MANAGER_ID", length = 20)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiBelongManagerId))
			return false;
		HMCiBelongManagerId castOther = (HMCiBelongManagerId) other;

		return ((this.getBelongManagerId() == castOther.getBelongManagerId()) || (this
				.getBelongManagerId() != null
				&& castOther.getBelongManagerId() != null && this
				.getBelongManagerId().equals(castOther.getBelongManagerId())))
				&& ((this.getCustId() == castOther.getCustId()) || (this
						.getCustId() != null
						&& castOther.getCustId() != null && this.getCustId()
						.equals(castOther.getCustId())))
				&& ((this.getCustManagerType() == castOther
						.getCustManagerType()) || (this.getCustManagerType() != null
						&& castOther.getCustManagerType() != null && this
						.getCustManagerType().equals(
								castOther.getCustManagerType())))
				&& ((this.getCustManagerNo() == castOther.getCustManagerNo()) || (this
						.getCustManagerNo() != null
						&& castOther.getCustManagerNo() != null && this
						.getCustManagerNo()
						.equals(castOther.getCustManagerNo())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getBelongManagerId() == null ? 0 : this.getBelongManagerId()
						.hashCode());
		result = 37 * result
				+ (getCustId() == null ? 0 : this.getCustId().hashCode());
		result = 37
				* result
				+ (getCustManagerType() == null ? 0 : this.getCustManagerType()
						.hashCode());
		result = 37
				* result
				+ (getCustManagerNo() == null ? 0 : this.getCustManagerNo()
						.hashCode());
		result = 37 * result
