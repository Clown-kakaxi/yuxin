...
/**
 * HMImImageInfoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMImImageInfoId implements java.io.Serializable {
	...
	/** default constructor */
	public HMImImageInfoId() {
	}

	/** minimal constructor */
	public HMImImageInfoId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMImImageInfoId(String imageIndexId, String imageContent,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMImImageInfoId))
			return false;
		HMImImageInfoId castOther = (HMImImageInfoId) other;
		...
		return ((this.getImageIndexId() == castOther.getImageIndexId()) || (this
				...
				&& ((this.getImageContent() == castOther.getImageContent()) || (this
						.getImageContent() != null
						&& castOther.getImageContent() != null && this
						.getImageContent().equals(castOther.getImageContent())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getImageContent() == null ? 0 : this.getImageContent()
						.hashCode());
		result = 37
				* result
