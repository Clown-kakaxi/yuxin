...
/**
 * HMCiNationRiskId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiNationRiskId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiNationRiskId() {
	}

	/** minimal constructor */
	public HMCiNationRiskId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiNationRiskId(String riskNationCode, String riskLevel,
			Double rate, String lastUpdateSys, String lastUpdateUser,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiNationRiskId))
			return false;
		HMCiNationRiskId castOther = (HMCiNationRiskId) other;

		return ((this.getRiskNationCode() == castOther.getRiskNationCode()) || (this
				.getRiskNationCode() != null
				&& castOther.getRiskNationCode() != null && this
				.getRiskNationCode().equals(castOther.getRiskNationCode())))
