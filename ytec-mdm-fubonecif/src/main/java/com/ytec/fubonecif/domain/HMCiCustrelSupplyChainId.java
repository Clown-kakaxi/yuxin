...
/**
 * HMCiCustrelSupplyChainId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class HMCiCustrelSupplyChainId implements java.io.Serializable {
	...
	/** default constructor */
	public HMCiCustrelSupplyChainId() {
	}

	/** minimal constructor */
	public HMCiCustrelSupplyChainId(Timestamp hisOperTime) {
		this.hisOperTime = hisOperTime;
	}

	/** full constructor */
	public HMCiCustrelSupplyChainId(String custRelId, String isMainProvider,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HMCiCustrelSupplyChainId))
			return false;
		HMCiCustrelSupplyChainId castOther = (HMCiCustrelSupplyChainId) other;
		...
		return ((this.getCustRelId() == castOther.getCustRelId()) || (this
				...
				&& ((this.getIsMainProvider() == castOther.getIsMainProvider()) || (this
						.getIsMainProvider() != null
						&& castOther.getIsMainProvider() != null && this
						.getIsMainProvider().equals(
								castOther.getIsMainProvider())))
				&& ((this.getIsMainSaler() == castOther.getIsMainSaler()) || (this
						.getIsMainSaler() != null
						&& castOther.getIsMainSaler() != null && this
						.getIsMainSaler().equals(castOther.getIsMainSaler())))
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getIsMainProvider() == null ? 0 : this.getIsMainProvider()
						.hashCode());
		result = 37
				* result
				+ (getIsMainSaler() == null ? 0 : this.getIsMainSaler()
						.hashCode());
		result = 37
				* result
