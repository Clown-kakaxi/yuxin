...
/**
 * HMCiPerLinkman entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "H_M_CI_PER_LINKMAN")
public class HMCiPerLinkman implements java.io.Serializable {

	// Fields

	private HMCiPerLinkmanId id;

	// Constructors

	/** default constructor */
	public HMCiPerLinkman() {
	}

	/** full constructor */
	public HMCiPerLinkman(HMCiPerLinkmanId id) {
		this.id = id;
	}
	...
	@AttributeOverrides( {
			...
			@AttributeOverride(name = "tel2", column = @Column(name = "TEL2", length = 20)),
	...
	public HMCiPerLinkmanId getId() {
		return this.id;
	}

	public void setId(HMCiPerLinkmanId id) {
		this.id = id;
	}
