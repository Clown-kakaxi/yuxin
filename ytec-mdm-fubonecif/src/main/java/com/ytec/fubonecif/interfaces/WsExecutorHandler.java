 ...
 * @文件名：WsExecutorHandler.java
 * @版本信息：1.0.0
 * @日期：2013-12-17-12:09:49
 ...
 * @类名称：WsExecutorHandler
 * @类描述：WEB SERVICE 接口案例
 * @功能描述:
 * @创建人：wangzy1@yuchengtech.com
 * @创建时间：2013-12-17 下午12:09:50   
 * @修改人：wangzy1@yuchengtech.com
 * @修改时间：2013-12-17 下午12:09:50
 * @修改备注：
 * @修改日期		修改人员		修改原因
 * --------    --------		----------------------------------------
 * @version 1.0.0
 ...
 * 
 */
public class WsExecutorHandler extends WsExecutor {

	private static Logger log = LoggerFactory
			.getLogger(WsExecutorHandler.class);

	public WsExecutorHandler() {
		super();
	}
