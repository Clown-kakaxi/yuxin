...
public class QueryLogInfo implements IEcifBizLogic{
	private JPABaseDAO baseDAO;
	private static Logger log = LoggerFactory.getLogger(QueryLogInfo.class);
	...
	public void process(EcifData ecifData) throws Exception {
		 ...
		 */
		//查询
		AdminLogInfo customer = null;
		Object o = bizGetObject(custNo);
		if(o!=null){
			customer = (AdminLogInfo)o;
		}else{
		...
		Element hand = customerEle.addElement("id");
		hand.setText(custNo);


		hand = customerEle.addElement("content");
		hand.setText(customer.getContent()==null?"":customer.getContent());
