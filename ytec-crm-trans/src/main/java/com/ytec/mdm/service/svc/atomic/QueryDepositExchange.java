...
public class QueryDepositExchange implements IEcifBizLogic{

	private JPABaseDAO baseDAO;
	private static Logger log = LoggerFactory.getLogger(QueryDepositExchange.class);
	...
	public void process(EcifData ecifData) throws Exception {
		...
		//账号
		String acctNo = body.element("acctNo").getTextTrim();
