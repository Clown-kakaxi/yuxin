...
public class ErrorCode {
	...
	public static final Error WRN_SUCCESS_PARTIAL_NO_DATA = new Error("010001|success but partial node has no data|成功但有警告(部分信息项无数据)");
	public static final Error WRN_NONE_FOUND = new Error("010002|no any record was found |未查到任何记录警告");
	...
	public static final Error WRN_BATCH_HAS_FAILURE = new Error("010008|at least one failure in batch process|批量处理有失败记录警告");

	public static final Error ERR_COMPRESS_FORMAT_NOT_SUPPORT = new Error("100001|comperss format is not suppert|不支持的压缩格式");
	public static final Error ERR_COMPRESS_LEVEL_NOT_SUPPORT = new Error("100002|comperss level is not suppert|不支持的压缩级别");
	...
	public static final Error ERR_ENCRYPTION_ALGORITHM_NOT_SUPPORT = new Error("150001|encryption algorithm is not support|不支持的加密算法");
	...
	public static final Error ERR_CLIENT_UNKNOWN_ERROR = new Error("250003|client authentication unknown error|客户端身份验证未知错误");
	public static final Error ERR_CLIENT_REQUEST_NOT_FOUND = new Error("250004|client request not found|请求服务不存在");
	public static final Error ERR_CLIENT_REQUEST_NOT_AUTHORIZED = new Error("250005|client request not authorized|请求服务未授权");
	public static final Error ERR_CLIENT_REQUEST_PARA_ERROR = new Error("250006|client request parameter error|请求服务参数错误");
	public static final Error ERR_CLIENT_AUTHORIZED_PW = new Error("250006|client request password err|请求授权密码为空");
	public static final Error ERR_CLIENT_BAD_REQUEST = new Error("250007|client request bad|请求非法");
	public static final Error ERR_CLIENT_REQUEST_UNKNOWN_ERROR = new Error("259999|client request unknown error|请求未知错误");
	public static final Error ERR_XML_CFG_DATATYPE_NOT_SUPPORT = new Error("280001|xml message configure data type not support|XML报文配置数据类型不支持");
	public static final Error ERR_XML_CFG_DATAFMT_NOT_FOUND = new Error("280002|xml message configure data format not found|XML报文配置数据格式未定义");
	public static final Error ERR_XML_CFG_DATA_STDCODE_NULL = new Error("280003|xml message configure data has no standard code|XML报文配置属性标准代码为空");
	public static final Error ERR_XML_CFG_NO_ROOT_NODE = new Error("280004|xml message configure no root node|XML报文配置没有配置根节点");
	public static final Error ERR_XML_CFG_NO_FILTER = new Error("280005|xml message configure no filter|XML报文配置找不到查询条件");
	public static final Error ERR_XML_CFG_NO_FK = new Error("280006|xml message configure no foreign key|XML报文配置找不到外键参数");
	public static final Error ERR_XML_CFG_NO_CHECKINFO = new Error("280007|xml message configure no check info|XML报文配置找不到校验文档");
	public static final Error ERR_XML_CHECKSUM_ERR = new Error("280008|xml message checksum info error|报文校验信息出错");

	public static final Error ERR_XML_CFG_UNKNOWN_ERROR = new Error("289999|xml message configure unknown error|XML报文配置未知错误");
	...
	public static final Error ERR_XML_NO_SUCH_TXNO = new Error("300005|request xml message number is not exist|XML报文编号不存在");
	public static final Error ERR_XML_NO_SUCH_TXCODE = new Error("300006|request xml message transaction code is not exist|XML报文交易代码不存在");
	public static final Error ERR_XML_NO_SUCH_TXNAME = new Error("300007|request xml message service name is not exist|XML报文服务名称不存在");
	public static final Error ERR_XML_FILTER_VALUE_IS_NULL = new Error("300008|request xml message filter value is null|XML报文查询条件为空");
	...
	public static final Error ERR_FIX_UNKNOWN_ERROR = new Error("359999|request fixed length message unknown error|定长报文未知错误");
	...
	public static final Error ERR_ECIF_NULL_SRCSYSCUSTNO = new Error("600105|source system customer number is null or blank|源系统客户号为空");
	public static final Error ERR_ECIF_NULL_ECIFCUSTNO = new Error("600106|ECIF customer number is null or blank|ECIF客户号为空");
	...
	public static final Error ERR_ECIF_INVALID_SRCCUSTNO = new Error("600301|invalid source system customer number|源系统客户号校验不通过");
	public static final Error ERR_ECIF_INVALID_ECIFCUSTNO = new Error("600302|invalid ECIF customer number|ECIF客户号校验不通过");
	...
	public static final Error ERR_ECIF_INVALID_REQ_PARA = new Error("600700|invalid request parameters|请求报文中参数不合法,含有非法字符");
	public static final Error ERR_ECIF_NOT_EXIST_SRCSYSCUSTNO = new Error("600701|source customer number is not exist|源系统客户号不存在");
	public static final Error ERR_ECIF_NOT_EXIST_ECIFCUSTNO = new Error("600702|ecif customer number is not exist|ECIF客户号不存在");
	...
	public static final Error ERR_ECIF_NOT_EXIST_IDENT = new Error("600706|identifier is not exist|证件不存在");
	public static final Error ERR_ECIF_NOT_EXIST_PK = new Error("600707|primary key is not exist|主键不存在");
	public static final Error ERR_ECIF_NOT_EXIST_TECHNICALKEY = new Error("600708|technical key key is not exist|技术主键不存在");
	public static final Error ERR_ECIF_NOT_EXIST_BUSINESSKEY = new Error("600709|business key is not exist|业务主键不存在");
	...
	public static final Error ERR_ECIF_NOT_SUPPORT_IDENTIFY_RULE = new Error("600801|identify rule is not support|不支持的客户识别规则");
	public static final Error ERR_ECIF_NOT_SUPPORT_SUSPECT_RULE = new Error("600802|suspect rule is not support|不支持的疑似客户识别规则");
	public static final Error ERR_ECIF_NOT_SUPPORT_IDENTIFY_RULE_COMB = new Error("600803|identify rule combination is not support|不支持的客户识别规则组合");
	public static final Error ERR_ECIF_NOT_SUPPORT_SUSPECT_RULE_COMB = new Error("600804|suspect rule combination is not support|不支持的疑似客户识别规则组合");
	public static final Error ERR_ECIF_NOT_SUPPORT_MERGE_RULE = new Error("600805|customer merge rule is not support|不支持的客户归并规则");
	public static final Error ERR_ECIF_NOT_SUPPORT_MERGE_METHOD = new Error("600806|customer merge method is not support|不支持的客户归并方式");
	public static final Error ERR_ECIF_NOT_SUPPORT_COVER_RULE = new Error("600807|customer cover rule is not support|不支持的客户信息覆盖规则");
	public static final Error ERR_ECIF_NOT_SUPPORT_SPLIT_RULE = new Error("600808|customer split rule is not support|不支持的客户拆分规则");
	...
	public static final Error ERR_ECIF_GEN_ECIFCUSTNO_ERROR = new Error("601002|generate ECIF customer number error|生成ECIF客户号异常");
	...
	public static final Error ERR_COMM_PROTOCOL_NOT_SUPPORT = new Error("800001|communicate protocol not support|不支持的通讯协议");
