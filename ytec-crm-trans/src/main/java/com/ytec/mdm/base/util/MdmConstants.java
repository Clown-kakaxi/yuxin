...
public class MdmConstants {
	...
	public static final String TIME_FORMAMT = "yyyy-MM-dd HH:mm:ss";

	public static final String DATE_FORMAMT = "yyyy-MM-dd";

	public static SimpleDateFormat DATE_FORMAT_10 = new SimpleDateFormat(MdmConstants.DATE_FORMAMT);
	public static SimpleDateFormat DATE_FORMAT_19 = new SimpleDateFormat(MdmConstants.TIME_FORMAMT);
	 ...
	 * @属性描述:
	 */
	public static final String TX_DEF_GETCONTID_ECIFCUSTNO =  "custId";
	// 按三证识别
	/**
