...
public class FtpOperator {
	...
	public static void main(String[] args) {
		FtpOperator fp = new FtpOperator("192.168.1.98",21,"ecif","ecif","/home/ecif/usr/wangzhanyuan/ytec_mdm_core","D://");
		fp.downloadFile("ecifAdmin");
		//fp.uploadFile("testdata_new.txt");
	}
