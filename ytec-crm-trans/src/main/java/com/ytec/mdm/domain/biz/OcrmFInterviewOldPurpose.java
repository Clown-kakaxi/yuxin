...
public class OcrmFInterviewOldPurpose implements Serializable {
	@Id
	@SequenceGenerator(name = "OCRM_F_INTERVIEW_OLD_PURPOSE_ID_GENERATOR", sequenceName = "ID_SEQUENCE")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OCRM_F_INTERVIEW_OLD_PURPOSE_ID_GENERATOR")
