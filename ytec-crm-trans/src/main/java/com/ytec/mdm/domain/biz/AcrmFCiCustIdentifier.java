...
public class AcrmFCiCustIdentifier implements Serializable {
	@Id
//	@SequenceGenerator(name="ACRM_F_CI_CUST_IDENTIFIER_IDENTID_GENERATOR", sequenceName="SEQ_IDENT_ID")
//	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CI_CUST_IDENTIFIER_IDENTID_GENERATOR")
