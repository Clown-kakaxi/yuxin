...
<script type="text/javascript">
	...
	$(function() {
		url = "${ctx}/ecif/transaction/txerr/list.json";
		searchForm();
		initGrid();
		initButtons();
		...
		grid = $("#maingrid").ligerGrid(
				{
					...
					onDblClickRow : function(rowdata, rowindex, rowDomElement){//双击选择
						//debugger;
					    dialog = BIONE.commonOpenLargeDialog("错误日志信息", "authResWin",
							    "${ctx}/ecif/transaction/txerr/" + rowdata.txErrId  +"/edit"  
								    );
					},
					toolbar : {}
				});
