 ...
 *        锟�002-2009 Open Lab srl, Matteo Bicocchi
        ...
        $(root).each(function(){
          ...
          if (this.options.hoverIntent==0){
            ...
            $(thisMenu.menuvoice).bind(mouseOver,function(){
                $(thisMenu.menuvoice).each(function(){
                  	$(this).find('#rootVoiceSideFirst').removeClass('first_selected');
                    $(this).find('.rightside').removeClass("selected_prev");
                    $(this).find('.rightside').removeClass("selected_next");
                    $(this).find('.rightside').addClass("noselected");
                    $(this).find('.rightside').removeClass("last_selected");
              ...
              if($(this).find('#rootVoiceSideFirst').hasClass('first')){
            	  $(this).find('#rootVoiceSideFirst').addClass('first_selected');
              }else{
                  $(this).prev().find('.rightside').removeClass("noselected");
                  $(this).prev().find('.rightside').addClass("selected_prev");
              }
              
              $(this).find('#rootVoiceContent').addClass("selected");
              
              if($(this).find('.rightside').hasClass('last')){
            	  $(this).find('.rightside').addClass('last_selected');
              }else{
            	  if($(thisMenu.menuvoice).size()==1){
            		  $(this).find('.rightside').addClass('last_selected');
            	  }else{
            		  $(this).find('.rightside').addClass("selected_next");
            	  }
              }
            ...
            $(thisMenu.menuvoice).bind(mouseOut,function(){
              ...
              if ($(this).attr("menu")=="empty"){
                  ...
                  if($(this).find('#rootVoiceSideFirst').hasClass('first')){
                     ...
                     $(this).prev().find('.rightside').removeClass("selected_prev");
                  }
                  
                  $(this).find('#rootVoiceContent').removeClass("selected");
              	...
              	if($(this).attr("current")=="true"){
                    ...
                    if($(this).find('.rightside').hasClass('last')){
              		...
              		if($(this).find('#rootVoiceSideFirst').hasClass('first')){
                       ...
                       $(this).prev().find('.rightside').removeClass("selected_prev");
                       $(this).prev().find('.rightside').addClass("noselected");
                       $(this).find('#rootVoiceContent').removeClass("selected");
                    }
