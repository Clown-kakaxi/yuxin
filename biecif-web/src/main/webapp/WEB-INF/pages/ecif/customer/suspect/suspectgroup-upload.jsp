...
<script type="text/javascript" src="${ctx}/js/plupload/i18n/cn.js"></script>t>
<script type="text/javascript">
	...
	$(function() {
		$("#uploader").pluploadQueue({
			...
			url : '${ctx}/ecif/customer/suspectgroup/startUpload',
			max_file_size : '100MB',
			unique_names : true,
			chunk_size : '10MB',
	...
	function doDownload(file) {
		...
		var form = $('<form/>').attr({
			target: '',
			method: 'post',
			action: '${ctx}/ecif/customer/suspectgroup/export.xls?'+new Date().getTime()
		}).css('display', 'none');
