...
<script type="text/javascript">
		...
		/* 	labelWidth : 80,
			...
			fields : [ {
				...
				options : {
					...
					url : "${ctx}/ecif/customer/custsplitrecordapp/getComBoBox.json",
					ajaxType : "get"
				},
				validate : {
					required : true,
	...
	function validateUser(){
		...
		if(ids != ""){
			...
			$.ajax({
				url: '${ctx}/ecif/customer/custsplitrecordapp/validateuser?'+timestamp,
				async : false,
				type: 'get',
				data: {
					ids: ids
...
<body>
	<div id="template.center">
		<form id="mainform" action="${ctx}/ecif/customer/custsplitrecordapp" method="post"></form>
	</div>
</body>
</html>