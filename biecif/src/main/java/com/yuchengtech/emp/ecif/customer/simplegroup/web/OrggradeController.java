...
import com.yuchengtech.emp.ecif.customer.entity.orgevaluate.Orggrade;
import com.yuchengtech.emp.ecif.customer.simplegroup.service.OrggradeBS;
@Controller
@RequestMapping("/ecif/orgevaluate/orggrade")
public class OrggradeController extends BaseController {
	@Autowired
	private OrggradeBS OrggradeBS;
	@Autowired
	private ResultUtil resultUtil;
	protected static Logger log = LoggerFactory
			.getLogger(OrggradeController.class);
	...
	@ResponseBody
		public Map<String, Object> showOrggrade(Pager pager,@RequestParam("custId") long custId) {
			Map<String, Object> userMap = Maps.newHashMap();
			SearchResult<Orggrade> searchResult = OrggradeBS.getOrggradeList(
