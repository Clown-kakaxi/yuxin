...
/**
 * The persistent class for the TX_SYNC_LOG database table.
 * 
 */
@Entity
@Table(name="TX_SYNC_LOG")
public class TxSyncLog implements Serializable {
	...
	public Date getSyncDealTime() {
		return this.syncDealTime;
	}

	public void setSyncDealTime(Date syncDealTime) {
