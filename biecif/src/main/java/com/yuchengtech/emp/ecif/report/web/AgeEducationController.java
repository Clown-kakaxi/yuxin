 ...
 * 
 * <pre>
 * Title:个人客户统计表  年龄段分析报表&最高学历分析报表Controller端
 * Description: 
 * </pre>
 * 
 ...
 */
@Controller
@RequestMapping("/ecif/report/age")
public class AgeEducationController extends BaseController {
	...
	protected static Logger log = LoggerFactory.getLogger(AgeEducationController.class);
	
	@RequestMapping(method = RequestMethod.GET)
	public String index() {
		flag = false;
		return "/ecif/report/ageeducation-index";
	}
	...
	public Map<String, Object> list(Pager pager) {
		...
		SearchResult<Map<String, String>> searchResult = rptPersonInfoDetailBS
				.queryRptPersonInfo(pager.getPageFirstIndex(),
						...
						ReportConstant.RPT_PERSON_INFO_DETAIL_REPORTTYPE_AGE_EDUCATION);
	...
	public void export(HttpServletResponse response, String file)
		...
		ExportUtil.download(response, new File(file), "application/vnd.ms-excel", GlobalConstants.EXCEL_REPORT_AGEEDUCATION_CN + "_" + date + ".xlsx");
	...
	public String getReportFile(String rptMonth, String createBranchNo) {
		return this.rptPersonInfoDetailBS.export(rptMonth, createBranchNo, ReportConstant.RPT_PERSON_INFO_DETAIL_REPORTTYPE_AGE_EDUCATION);
	}
}
