...
public class TxSyncErrBS extends BaseBS<TxSyncErr> {
	@SuppressWarnings("unchecked")
	public SearchResult<TxSyncErr> getTxSyncErrList(int firstResult, int pageSize, String orderBy, String orderType,
		...
		jql.append("select TxSyncErr from TxSyncErr TxSyncErr where 1=1");
		...
		SearchResult<TxSyncErr> TxLogList = this.baseDAO.findPageWithNameParam(firstResult, pageSize,
				newjql, values);
		return TxLogList;
	}
