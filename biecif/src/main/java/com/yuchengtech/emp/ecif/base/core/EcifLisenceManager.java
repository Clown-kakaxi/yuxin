 ...
 * @since  
 */
public class EcifLisenceManager {
	...
	private static Logger log = Logger.getLogger(EcifLisenceManager.class);
	
	private static EcifLisenceManager instance;
	
	public static EcifLisenceManager getInstance(){
		if(null == instance){
			instance = new EcifLisenceManager();
		}
		return instance;
	}
