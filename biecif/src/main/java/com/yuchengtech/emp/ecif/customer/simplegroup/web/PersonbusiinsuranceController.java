...
import com.yuchengtech.emp.ecif.customer.simplegroup.service.PersonbusiinsuranceBS;
@Controller
@RequestMapping("/ecif/perrisk/personbusiinsurance")
public class PersonbusiinsuranceController extends BaseController {
	@Autowired
	private PersonbusiinsuranceBS PersonbusiinsuranceBS;
	@Autowired
	private ResultUtil resultUtil;
	protected static Logger log = LoggerFactory
			.getLogger(PersonbusiinsuranceController.class);
	...
	@ResponseBody
		public Map<String, Object> showPersonbusiinsurance(Pager pager,@RequestParam("custId") long custId) {
			...
			SearchResult<Personbusiinsurance> searchResult = PersonbusiinsuranceBS.getPersonbusiinsuranceList(
