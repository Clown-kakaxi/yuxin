...
import com.yuchengtech.emp.ecif.customer.simplegroup.service.MendinfoBS;
@Controller
@RequestMapping("/ecif/orgrisk/mendinfo")
public class MendinfoController extends BaseController {
	@Autowired
	private MendinfoBS MendinfoBS;
	@Autowired
	private ResultUtil resultUtil;
	protected static Logger log = LoggerFactory
			.getLogger(MendinfoController.class);
	...
	@ResponseBody
		public Map<String, Object> showMendinfo(Pager pager,@RequestParam("custId") long custId) {
			...
			SearchResult<Mendinfo> searchResult = MendinfoBS.getMendinfoList(
