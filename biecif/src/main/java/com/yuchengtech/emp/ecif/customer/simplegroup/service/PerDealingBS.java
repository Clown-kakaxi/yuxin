...
public class PerDealingBS extends BaseBS<Object> {
	 ...
	 * @return
	 */
	// 展示Personspecialcust的页面
	@SuppressWarnings("unchecked")
	public SearchResult<Personspecialcust> getPersonspecialcustList(int firstResult, int pageSize,
			String orderBy, String orderType, Map<String, Object> conditionMap,
			long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select obj from Personspecialcust obj where 1=1");
	...
	// 展示Personchannelsign的页面
	@SuppressWarnings("unchecked")
	public SearchResult<Personchannelsign> getPersonchannelsignList(int firstResult,
			int pageSize, String orderBy, String orderType,
			Map<String, Object> conditionMap, long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select rel from Personchannelsign rel where 1=1");
		if (!conditionMap.get("jql").equals("")) {
			jql.append(" and " + conditionMap.get("jql"));
		}
		if (!"".equals(custId)) {
