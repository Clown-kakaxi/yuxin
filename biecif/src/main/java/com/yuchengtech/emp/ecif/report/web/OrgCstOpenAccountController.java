 ...
 */
@Controller
@RequestMapping("/ecif/report/openaccount")
public class OrgCstOpenAccountController extends BaseController {
	...
	protected static Logger log = LoggerFactory.getLogger(OrgCstOpenAccountController.class);
	
	@RequestMapping(method = RequestMethod.GET)
	public String index() {
		flag = false;
		return "/ecif/report/orgcstopenaccount-index";
	}
	...
	public Map<String, Object> list(Pager pager) {
		...
		SearchResult<Map<String, String>> searchResult = rptCstAcctChangeInfoBS
				.rptCstAcctChangeInfo(pager.getPageFirstIndex(),
						...
						ReportConstant.RPT_CUST_ACCT_CHANGE_INFO_CUST_ACCT_STS_CSTOPEN);
	...
	public void export(HttpServletResponse response, String file)
		...
		ExportUtil.download(response, new File(file), "application/vnd.ms-excel", GlobalConstants.EXCEL_REPORT_ORGCSTOPEN_CN + "_" + date + ".xlsx");
	...
	public String getReportFile(String srptMonth, String erptMonth, String createBranchNo) {
		String custAcctSts = ReportConstant.RPT_CUST_ACCT_CHANGE_INFO_CUST_ACCT_STS_CSTOPEN;
