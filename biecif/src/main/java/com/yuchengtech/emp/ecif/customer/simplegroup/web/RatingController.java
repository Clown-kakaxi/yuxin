...
import com.yuchengtech.emp.ecif.customer.simplegroup.service.RatingBS;
@Controller
@RequestMapping("/ecif/orgrisk/rating")
public class RatingController extends BaseController {
	@Autowired
	private RatingBS RatingBS;
	@Autowired
	...
	@ResponseBody
		public Map<String, Object> showRating(Pager pager,@RequestParam("custId") long custId) {
			...
			SearchResult<Rating> searchResult = RatingBS.getRatingList(
