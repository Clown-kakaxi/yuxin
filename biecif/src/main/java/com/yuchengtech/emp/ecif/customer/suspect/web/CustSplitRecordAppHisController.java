 ...
 */
@Controller
@RequestMapping("/ecif/customer/custsplitrecordapphis")
public class CustSplitRecordAppHisController extends BaseController {
	...
	public String index() {
		flag = false;
		return "/ecif/customer/suspect/custsplitrecordapphis-index";
	}
