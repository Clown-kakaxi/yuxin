...
import com.yuchengtech.emp.ecif.customer.entity.permanage.Belonglinedept;
import com.yuchengtech.emp.ecif.customer.simplegroup.service.BelonglinedeptBS;
@Controller
@RequestMapping("/ecif/permanage/belonglinedept")
public class BelonglinedeptController extends BaseController {
	@Autowired
	private BelonglinedeptBS BelonglinedeptBS;
	@Autowired
	private ResultUtil resultUtil;
	protected static Logger log = LoggerFactory
			.getLogger(BelonglinedeptController.class);
	...
	@ResponseBody
		public Map<String, Object> showBelonglinedept(Pager pager,@RequestParam("custId") long custId) {
			...
			SearchResult<Belonglinedept> searchResult = BelonglinedeptBS.getBelonglinedeptList(
