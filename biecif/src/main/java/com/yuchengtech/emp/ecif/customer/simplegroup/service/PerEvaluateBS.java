...
public class PerEvaluateBS extends BaseBS<Object> {
	...
	public SearchResult<Scoreinfo> getScoreinfoList(int firstResult, int pageSize,
	...
	// 展示Personstarlevel的页面
	@SuppressWarnings("unchecked")
	public SearchResult<Personstarlevel> getPersonstarlevelList(int firstResult,
			int pageSize, String orderBy, String orderType,
			Map<String, Object> conditionMap, long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select obj from Personstarlevel obj where 1=1");
		if (!conditionMap.get("jql").equals("")) {
			jql.append(" and " + conditionMap.get("jql"));
		}
		if (!"".equals(custId)) {
	...
	public SearchResult<Persongrade> getPersongradeList(int firstResult,
			...
			Map<String, Object> conditionMap, long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select obj from Persongrade obj where 1=1");
		if (!conditionMap.get("jql").equals("")) {
			jql.append(" and " + conditionMap.get("jql"));
		}
		if (!"".equals(custId)) {
	...
	public SearchResult<Personpoint> getPersonpointList(int firstResult,
			...
			Map<String, Object> conditionMap, long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select obj from Personpoint obj where 1=1");
		if (!conditionMap.get("jql").equals("")) {
			jql.append(" and " + conditionMap.get("jql"));
		}
		if (!"".equals(custId)) {
	...
	// 展示Personpreference的页面
	@SuppressWarnings("unchecked")
	public SearchResult<Personpreference> getPersonpreferenceList(int firstResult,
			int pageSize, String orderBy, String orderType,
			Map<String, Object> conditionMap, long custId) {
		StringBuffer jql = new StringBuffer("");
		jql.append("select obj from Personpreference obj where 1=1");
		if (!conditionMap.get("jql").equals("")) {
			jql.append(" and " + conditionMap.get("jql"));
		}
		if (!"".equals(custId)) {
