 ...
 * 
 * <pre>
 * Title:个人客户统计表  客户分布分析报表Controller端
 * Description: 
 * </pre>
 * 
 ...
 */
@Controller
@RequestMapping("/ecif/report/distribution")
public class CstDistributionController extends BaseController {
	...
	protected static Logger log = LoggerFactory.getLogger(CstDistributionController.class);
	
	@RequestMapping(method = RequestMethod.GET)
	public String index() {
		flag = false;
		return "/ecif/report/cstdistribution-index";
	}
	...
	public Map<String, Object> list(Pager pager) {
		...
		SearchResult<Map<String, String>> searchResult = rptPersonInfoDetailBS
				.queryRptPersonInfo(pager.getPageFirstIndex(),
						...
						ReportConstant.RPT_PERSON_INFO_DETAIL_REPORTTYPE_DISTRIBUTION);
	...
	public void export(HttpServletResponse response, String file)
		...
		ExportUtil.download(response, new File(file), "application/vnd.ms-excel", GlobalConstants.EXCEL_REPORT_CSTDISTRIBUTION_CN + "_" + date + ".xlsx");
	...
	public String getReportFile(String rptMonth, String createBranchNo) {
		return this.rptPersonInfoDetailBS.export(rptMonth, createBranchNo, ReportConstant.RPT_PERSON_INFO_DETAIL_REPORTTYPE_DISTRIBUTION);
	}
}
