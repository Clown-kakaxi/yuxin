...
import com.yuchengtech.emp.ecif.customer.simplegroup.service.DefaultinfoBS;
@Controller
@RequestMapping("/ecif/orgrisk/defaultinfo")
public class DefaultinfoController extends BaseController {
	@Autowired
	private DefaultinfoBS DefaultinfoBS;
	@Autowired
	private ResultUtil resultUtil;
	protected static Logger log = LoggerFactory
			.getLogger(DefaultinfoController.class);
	...
	@ResponseBody
		public Map<String, Object> showDefaultinfo(Pager pager,@RequestParam("custId") long custId) {
			...
			SearchResult<Defaultinfo> searchResult = DefaultinfoBS.getDefaultinfoList(
