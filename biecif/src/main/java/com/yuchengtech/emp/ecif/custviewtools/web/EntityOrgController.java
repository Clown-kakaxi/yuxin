 ...
 */
@Controller
@RequestMapping("/ecif/orgcustviewtools")
public class EntityOrgController extends BaseController {
	protected static Logger log = LoggerFactory.getLogger(EntityOrgController.class);

	@RequestMapping(method = RequestMethod.GET)
	public String index() {
		return "/ecif/custviewtools/orgentity-index";
	}
	...
	public Map<String, Object> list(Pager pager) {
		...
		List<EntityVO> entityList = MakeUtils.getEntityList(MakeUtils.class.getResource("/").getPath()+MakeConstants.ORG_XMLFILE) ;
	...
	public void genfiles(@PathVariable("id") String id) {
		String[] ids = id.split(",");
		String xml = MakeUtils.readFile(MakeUtils.class.getResource("/").getPath()+MakeConstants.ORG_XMLFILE);
