...
/**
 * TxAlarmWeb entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TX_ALARM_WEB")
public class TxAlarmWeb implements java.io.Serializable {
	...
	/** minimal constructor */
	public TxAlarmWeb(Long alarmId) {
		this.alarmId = alarmId;
	}

	/** full constructor */
	public TxAlarmWeb(Long alarmId, Long userId, String userName,
			String userTitle, String loginName, String alarmSys,
