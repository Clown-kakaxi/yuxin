...
/**
 * TxSyncLog entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TX_SYNC_LOG")
public class TxSyncLog implements java.io.Serializable {
	...
	/** full constructor */
	public TxSyncLog(Long syncConfId, String txCode, String srcSysNo,
