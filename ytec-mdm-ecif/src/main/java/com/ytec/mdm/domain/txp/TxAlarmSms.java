...
/**
 * TxAlarmSms entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "TX_ALARM_SMS")
public class TxAlarmSms implements java.io.Serializable {
	...
	/** minimal constructor */
	public TxAlarmSms(Long alarmId) {
		this.alarmId = alarmId;
	}

	/** full constructor */
	public TxAlarmSms(Long alarmId, Long userId, String userName,
			String userTitle, String smsAddr, String alarmSys,
