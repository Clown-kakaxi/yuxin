...
package com.ytec.mdm.base.util.charsetDetector.jchardet ;
...
public abstract class nsPSMDetector {
   ...
   public nsPSMDetector(nsVerifier[] aVerifierSet, 
			nsEUCStatistics[] aStatisticsSet)  {
	   this(aVerifierSet.length,aVerifierSet,aStatisticsSet);
   }
   
   public nsPSMDetector(nsVerifier[] aVerifierSet)  {
	   this(aVerifierSet,null);
   }
