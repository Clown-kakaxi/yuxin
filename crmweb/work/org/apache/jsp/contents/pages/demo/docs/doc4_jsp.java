package org.apache.jsp.contents.pages.demo.docs;
...
public final class doc4_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	/*	if(auth.getAttribute("crm.front.WS").equals("ra_normal")){
      ...
      out.write("\ttextarea {display: block;}\r\n");
      out.write("</style>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/contents/resource/kindeditor/kindeditor-all.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(request.getContextPath());
      out.write("/contents/resource/kindeditor/lang/zh_CN.js\"></script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<form>\r\n");
      out.write("\t<textarea name=\"content\" style=\"width:100%;height:360px;visibility:hidden;\"></textarea>\r\n");
      out.write("\t<p align=\"center\">\r\n");
      out.write("\t\t<input type=\"button\" name=\"saveText\" value=\"保存文档\" />\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"pid\" value=\"\" />\r\n");
      out.write("\t</p>\r\n");
      out.write("\t\r\n");
      out.write("</form>\r\n");
      out.write("<script>\r\n");
      out.write("\tvar requestStr = document.location.search;\r\n");
      out.write("\tvar nodeId = requestStr.split('=')[1].split('&')[0];//节点ID\r\n");
      out.write("\t//var nodeName = requestStr.split('=')[2];//节点名\r\n");
      out.write("\t//document.getElementById('pid').innerHTML = nodeName+'--';\r\n");
      out.write("\tvar editor;\r\n");
      out.write("\tvar docid='';\r\n");
      out.write("\tfunction queryData()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tExt.Ajax.request({\r\n");
      out.write("\t\t\turl:basepath+'/ocrmSysRicheditInfo!indexPage.json',\r\n");
      out.write("\t\t\tmethod:'GET',\r\n");
      out.write("\t\t\tparams:{\r\n");
      out.write("\t\t\t\trelId:nodeId\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tsuccess:function(r){\r\n");
      out.write("\t\t\t\tif(Ext.decode(r.responseText).json.data.length>0){\r\n");
      out.write("\t\t\t\t\tdocid = Ext.decode(r.responseText).json.data[0].id;\r\n");
      out.write("\t\t\t\t\tvar context = Ext.decode(r.responseText).json.data[0].content;\r\n");
      out.write("\t\t\t\t\teditor.html(context);\r\n");
      out.write("\t\t\t\t\t//editor.insertHtml(context);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},failure:function(){\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction queryData(nodeId)\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\t\t\tuploadJson : basepath + '/contents/resource/kindeditor/upload/upload_json.jsp',\r\n");
      out.write("\t\t\tfileManagerJson : basepath + '/contents/resource/kindeditor/upload/file_manager_json.jsp'\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tK('input[name=saveText]').click(function(e) {\r\n");
      out.write("\t\t\tExt.Ajax.request({\r\n");
      out.write("\t\t\t\turl:basepath+'/ocrmSysRicheditInfo.json',\r\n");
      out.write("\t\t\t\tmethod:'post',\r\n");
      out.write("\t\t\t\tparams:{\r\n");
      out.write("\t\t\t\t\twordId : docid,\r\n");
      out.write("\t\t\t\t\trelId:parent.loadQueryData(),\r\n");
      out.write("\t\t\t\t\tcontent:editor.html()\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\tsuccess:function(r){\r\n");
      out.write("\t\t\t\t\talert('保存成功!');\r\n");
      out.write("\t\t\t\t\tqueryData(parent.loadQueryData());\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\tqueryData(parent.loadQueryData());\r\n");
