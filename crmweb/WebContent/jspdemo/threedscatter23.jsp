...
double[] xData = r.getSeries2(20, 100, products1v, 10);
double[] yData = r.getSeries2(20, 100, ztradefinance03v, 10);
double[] zData = r.getSeries2(20, 100, ztradefinance04v, 10);
...
c.addTitle("Wallet-Size客户3D分析图  ", "宋体  Bold Italic", 16);
