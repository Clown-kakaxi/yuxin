...
double tradefinancepie33v=0.0;
double tradefinancepie33v1=0.0;
...
if(request.getParameter("tradefinancepie33v")!=""&&request.getParameter("tradefinancepie33v")!=null){
 tradefinancepie33v=Double.parseDouble(request.getParameter("tradefinancepie33v"));
};
 if(request.getParameter("tradefinancepie33v1")!=""&&request.getParameter("tradefinancepie33v1")!=null){
 tradefinancepie33v1=Double.parseDouble(request.getParameter("tradefinancepie33v1"));
}; 
...
if(!"".equals(request.getParameter("customerTypev"))&&request.getParameter("customerTypev")!=null){
	customerTypev=request.getParameter("customerTypev");
}; 
...
double[] dataX1 = {tradefinancepie33v1};
double[] dataY1 = {tradefinancepie33v};
double[] dataZ1 = {55};
...
c.addTitle("Wallet-Size客户二维分析图\n"+customerTypev, "宋体  Bold Italic", 14);

// Add titles to the axes using 12pt Arial Bold Italic font
c.yAxis().setTitle("Rate of Products", "Arial Bold Italic", 12);
...
c.addScatterLayer(dataX0, dataY0, "SOW(%)", Chart.SolidSphereShape, 15, 0xff3333
...
c.addScatterLayer(dataX1, dataY1, "Wallet-Size(%)", Chart.SolidSphereShape, 15, 0x0000ff
