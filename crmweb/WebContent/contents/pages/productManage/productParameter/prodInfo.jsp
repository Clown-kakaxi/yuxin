...
<html> 
	<head>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/demo/mktBusiOpporAddForm.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productPropertyList.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productagileSerch.js"></script> 
		<!-- 
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productInfoManage.js"></script> 
		 -->
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productParameter/prodInfo.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productParameter/prodParaAdd.js"></script>
			
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/com.yucheng.bcrm/com.yucheng.bcrm.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/productContrastRelation.js"></script>
		...
		<!-- START 生成商机、营销活动组件 -->
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportAddForm_CustList.js"></script>
