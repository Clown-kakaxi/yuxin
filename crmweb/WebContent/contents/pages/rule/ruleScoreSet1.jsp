...
<!-- 规则编辑页面-->
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/rule/ruleSetManeger1.js"></script>
<!-- 主页面 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/rule/ruleScoreSet1.js"></script>
