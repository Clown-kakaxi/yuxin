...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/goalGrogram/goalHome.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/productManage/goalGrogram/ycload.js"></script>	
</head>                                                        
<body>
