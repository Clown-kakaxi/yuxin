...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents\pages\wealthManage\businessDemand\stopLostInstall.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents\pages\wealthManage\businessDemand\stopLostInstallEdit.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents\pages\wealthManage\businessDemand\stopLostInstallDetail.js"></script>
</head>
<body>
</body>
</html>