...
Ext.onReady(function(){
	...
	var eduData = [
	            ['张三教育规划','张三','2013-08-26','2013-08-26','张三教育规划'],
	            ['李四教育规划','李四','2013-07-24','2013-08-26','李四教育规划'],
	            ['五XX教育规划','五XX','2013-08-26','2013-08-26','五XX教育规划'],
	            ['张XX教育规划','张XX','2013-07-26','2013-08-26','张XX教育规划'],
	            ['软三教育规划','软三','2013-11-25','2013-08-26','软三教育规划']
	];
	//定义自动当前页行号
	...
	new Ext.Viewport({//页面展示
		...
		frame : true,
		layout:'border',
		items : [finaSearchPanel,eduInfoGrid]
	});
