...
<head>
	...
	<!-- 功能性JS引入 -->
	<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/wealthManage/singlePlan/eduPlan.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/wealthManage/singlePlan/eduPlanCreate.js"></script>
