 ...
 * @since:2017.06.27
 */
Com.yucheng.bcrm.common.EconomicType = Ext.extend(Ext.form.TwinTriggerField, {	
	initComponent : function(){
		Com.yucheng.bcrm.common.EconomicType.superclass.initComponent.call(this);
	},
	onRender : function(ct, position){
		Com.yucheng.bcrm.common.EconomicType.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
	...
	onTrigger2Click : function() {
		...
		Ext.Ajax.request({
			url : basepath + '/economicTree.json',
			method : 'GET',
...
//									sName = sName + _this.busiTreeForShow.getSelectionModel().selNode.attributes.text;
								...
								qzCombaseInfo.form.findField('REGISTER_TYPE').removeClass("x-form-invalid");
							}
						}else{//多选状态
...
Ext.reg('economicType',Com.yucheng.bcrm.common.EconomicType);