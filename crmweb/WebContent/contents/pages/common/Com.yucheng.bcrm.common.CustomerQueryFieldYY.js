 ...
 */
Com.yucheng.bcrm.common.CustomerQueryFieldYY = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onRender : function(ct, position){
		Com.yucheng.bcrm.common.CustomerQueryFieldYY.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
...
//	    	},
    	...
    	_this.oCustomerQueryStore = new Ext.data.Store({
    		restful:true,	
    		proxy : new Ext.data.HttpProxy({url:basepath+'/customerBaseInformationYYAction.json?isNew='+oThisSearchField.isNew}),
    		reader: new Ext.data.JsonReader({
...
Ext.reg('customerqueryyy',Com.yucheng.bcrm.common.CustomerQueryFieldYY);
