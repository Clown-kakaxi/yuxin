...
(function() {
    ...
    Com.yucheng.bcrm.common.TipsWindow = Ext.extend(Ext.Window, {
        ...
        constructor: function(conf){
            Com.yucheng.bcrm.common.TipsWindow.superclass.constructor.call(this, conf);
            this.initPosition(true);
        },
        initEvents: function() {
           Com.yucheng.bcrm.common.TipsWindow.superclass.initEvents.call(this);
            //自动隐藏
