 ...
 * @since:2012.11.08
 */
Com.yucheng.bcrm.common.BusiType = Ext.extend(Ext.form.TwinTriggerField, {
	
	initComponent : function(){
		Com.yucheng.bcrm.common.BusiType.superclass.initComponent.call(this);
	},
	onRender : function(ct, position){
		Com.yucheng.bcrm.common.BusiType.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
	...
	onTrigger2Click : function() {
		...
		Ext.Ajax.request({
			url : basepath + '/businessTypeTree.json',
			method : 'GET',
...
Ext.reg('busiType',Com.yucheng.bcrm.common.BusiType);