...
//	    	},
    	...
    	_this.oCustomerQueryStore = new Ext.data.Store({
    		restful:true,	
    		proxy : new Ext.data.HttpProxy({url:basepath+'/customerBaseInformationlf.json?isNew='+oThisSearchField.isNew}),
    		reader: new Ext.data.JsonReader({
...
Ext.reg('customerqueryGLF',Com.yucheng.bcrm.common.CustomerQueryField);
