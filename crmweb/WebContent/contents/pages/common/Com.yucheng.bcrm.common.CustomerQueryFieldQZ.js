...
Ext.reg('customerqueryqz',Com.yucheng.bcrm.common.CustomerQueryFieldQZ);
    ...
    var addPotentialCustomerWindow = new Ext.Window({
		...
		buttons		  : [{
			...
			handler	: function() {
				...
				if(addPotentialCustomerPanel.form.findField('callNo').getValue() == '' && addPotentialCustomerPanel.form.findField('contmethInfo').getValue() == '') {
