...
Com.yucheng.crm.common.OrgUserManageNews = Ext.extend(Ext.form.TwinTriggerField, {
	initComponent : function(){
		Com.yucheng.crm.common.OrgUserManageNews.superclass.initComponent.call(this);
	},

	onRender : function(ct, position){
		Com.yucheng.crm.common.OrgUserManageNews.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
	...
	onTrigger2Click : function(){
		...
		_this.orgUserInfoColumns = new Ext.grid.ColumnModel([//gridtable中的列定义
		    ...
		    {header:'角色',dataIndex:'roleName',id:'roleName',width:160,sortable : true,hidden:false}
		]);
		...
		_this.orgUserManageProxy = new Ext.data.HttpProxy({
			url:basepath+'/orgusermanageNew.json'
		});
...
Ext.reg('userchooseNews',Com.yucheng.crm.common.OrgUserManageNews);