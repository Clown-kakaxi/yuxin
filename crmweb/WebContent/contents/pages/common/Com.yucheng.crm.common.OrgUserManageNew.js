...
Com.yucheng.crm.common.OrgUserManageNew = Ext.extend(Ext.form.TwinTriggerField, {
	initComponent : function(){
		Com.yucheng.crm.common.OrgUserManageNew.superclass.initComponent.call(this);
	},

	onRender : function(ct, position){
		Com.yucheng.crm.common.OrgUserManageNew.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
...
Ext.reg('userchooseNew',Com.yucheng.crm.common.OrgUserManageNew);