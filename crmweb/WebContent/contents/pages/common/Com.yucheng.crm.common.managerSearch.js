...
//		}
		...
		_this.orgUserManageInfoStore.baseParams={type:_this.ownerCt.ownerCt.ownerCt.getForm().findField('type')?_this.ownerCt.ownerCt.ownerCt.getForm().findField('type').getValue():''};
		// 每页显示条数下拉选择框
