...
Com.yucheng.crm.common.OrgCustomerUserManage = Ext.extend(Ext.form.TwinTriggerField, {
	initComponent : function(){
		Com.yucheng.crm.common.OrgCustomerUserManage.superclass.initComponent.call(this);
	},

	onRender : function(ct, position){
		Com.yucheng.crm.common.OrgCustomerUserManage.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
	...
	onTrigger2Click : function(){
		var clickOrgId = JsContext._orgId;
		if(this.disabled){ //禁用的放大镜不允许弹出选择
			return;
		}
		var _this= this;
		...
		_this.orgUserManageProxy = new Ext.data.HttpProxy({
			//url:basepath+'/orgCustomerUserManage.json'
			method : 'GET',
			url:basepath+"/oneKeyAccountAction!getCustomerUserManager.json"
		});
...
Ext.reg('customerUserchoose',Com.yucheng.crm.common.OrgCustomerUserManage);