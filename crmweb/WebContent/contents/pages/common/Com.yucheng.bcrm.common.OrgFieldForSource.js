 ...
 * @since:2012.11.08
 */
Com.yucheng.bcrm.common.OrgFieldForSource = Ext.extend(Ext.form.TwinTriggerField, {
	
	initComponent : function(){
		Com.yucheng.bcrm.common.OrgFieldForSource.superclass.initComponent.call(this);
	},
	onRender : function(ct, position){
		Com.yucheng.bcrm.common.OrgFieldForSource.superclass.onRender.call(this, ct, position);
		if(this.hiddenName){
			var ownerForm = this;
	...
	onTrigger2Click : function() {
		...
		//为郭耀锹特殊处理,此人为法金业务条线主管，但机构为企业金融部
	    if(JsContext._userId=='501N0485'){
	    	this.searchType='ALLORG';
	    }
...
Ext.reg('orgchooseSource',Com.yucheng.bcrm.common.OrgFieldForSource);