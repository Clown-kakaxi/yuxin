 ...
 */
Com.yucheng.bcrm.common.CustomerQueryField2 = Ext.extend(Ext.form.TwinTriggerField, {
...
//	    	},
    	...
    	_this.oCustomerQueryStore = new Ext.data.Store({
    		restful:true,	
    		proxy : new Ext.data.HttpProxy({url:basepath+'/customerBaseInformationlf2.json?isNew='+oThisSearchField.isNew}),
    		reader: new Ext.data.JsonReader({
...
Ext.reg('customerquery',Com.yucheng.bcrm.common.CustomerQueryField2);
