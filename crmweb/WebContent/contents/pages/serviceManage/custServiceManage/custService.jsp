...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/contents/pages/common/Com.yucheng.bcrm.common.CustomerQueryField.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/serviceManage/custServiceManage/custService.js"></script> 
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/serviceManage/custServiceManage/serviceExecute.js"></script>
	</head>
	<body>
	<input id="mktId" type="hidden"></input><input id="custIdExe" type="hidden"></input><input id="custNameExe" type="hidden"></input>
	</body>
</html>