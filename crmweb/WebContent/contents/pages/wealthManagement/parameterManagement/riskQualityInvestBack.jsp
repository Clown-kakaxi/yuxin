...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/wealthManagement/parameterManagement/riskQualityInvestBack.js"></script>

</head>
<body>
<div id="chartCont" align="center"></div>
</body>
</html>