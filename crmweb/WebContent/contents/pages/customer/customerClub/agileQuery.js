 ...
 * 数据集加载器
 */	
var loader2 = new Com.yucheng.bcrm.ArrayTreeLoader({
	...
	Ext.Ajax.request({
		...
		success : function(response) {
			...
			loader2.nodeArray = nodeArra.JSON.data;
			nodeArrays=nodeArra.JSON.data;
			for ( var item in loader2.nodeArray) {
				if (typeof loader2.nodeArray[item] === 'object') {
					if (loader2.nodeArray[item].TABLES == '2')
						loader2.nodeArray[item].NODEID = 'b' + loader2.nodeArray[item].NODEID;
				}
			}
			var children = loader2.loadAll();
		...
		var fnBatchSave2= function(){
			...
			Ext.Ajax.request({
				...
				params : {
					...
					group_id:editGroupBaseInfoForm.form.findField('id').getValue(),
					flag:ifadd,
					group_name:editGroupBaseInfoForm.form.findField('custBaseName').getValue(),
...
var agileQueryPanel2 = new Ext.Panel({
//	width : 1000,
	height : 390,
    	layout : 'column',
    	id:'info4',
