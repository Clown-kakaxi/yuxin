...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/workplat/reportManager/reportQueryManager.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/workplat/reportManager/reportCondition.js"></script>
