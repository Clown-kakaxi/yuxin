...
<head>
	...
	<script type="text/javascript">
		...
		var roleCodes='<%=request.getParameter("roleCodes")%>';
		 ...
		 var INSTRUCTION='<%=request.getParameter("INSTRUCTION")==null?"":request.getParameter("INSTRUCTION")%>';	//'INSTRUCTION  调整风险等级说明
		 
		 
		
	</script>
	<version:frameScript type="text/javascript" src="/contents/pages/wlj/custmanager/antiMoney/printManager/printAntMoneyAdjust.js"/>
