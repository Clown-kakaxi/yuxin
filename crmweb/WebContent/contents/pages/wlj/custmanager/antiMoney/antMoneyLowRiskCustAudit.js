...
var url=basepath+"/customerAntMoneyAuditQuery.json?riskLevel=L";
...
function orgFXQLevel(n){
	...
	var dqsh002= fxqORGLevelAuditPanel.form.findField("DQSH002").getValue()==""?0:fxqORGLevelAuditPanel.form.findField("DQSH002").getValue()*1;//					C    客户是否无法取得联系   DQSH0022
	var dqsh035= fxqORGLevelAuditPanel.form.findField("DQSH035").getValue()==""?0:fxqORGLevelAuditPanel.form.findField("DQSH035").getValue()*1;//					C    客户行为是否存在异常  DQSH0022
	var dqsh036= fxqORGLevelAuditPanel.form.findField("DQSH036").getValue()==""?0:fxqORGLevelAuditPanel.form.findField("DQSH036").getValue()*1;//					C    账户交易是否存在异常   DQSH0022
	var c=dqsh025+dqsh026+dqsh027+dqsh002+dqsh035+dqsh036;
	if(c>2){
		riskgradeStoreH.removeAll();
		 var da = [ [ '高风险', 'H' ],[ '中风险', 'M' ]];
		 riskgradeStoreH.loadData(da);
...
function perFXQLevel(n){
	...
	//c
	var dqsh001= fxqLevelAuditPanel.form.findField("DQSH001").getValue()==""?0:fxqLevelAuditPanel.form.findField("DQSH001").getValue()*1;//					C    证件是否过期      DQSH001
	var dqsh002= fxqLevelAuditPanel.form.findField("DQSH002").getValue()==""?0:fxqLevelAuditPanel.form.findField("DQSH002").getValue()*1;//					C    客户是否无法取得联系   DQSH0022
	var dqsh035= fxqLevelAuditPanel.form.findField("DQSH035").getValue()==""?0:fxqLevelAuditPanel.form.findField("DQSH035").getValue()*1;//					C    客户行为是否存在异常  DQSH0035
	var dqsh036= fxqLevelAuditPanel.form.findField("DQSH036").getValue()==""?0:fxqLevelAuditPanel.form.findField("DQSH036").getValue()*1;//					C    账户交易是否存在异常   DQSH0036
	var c=dqsh001+dqsh002+dqsh035+dqsh036;
	if(c>2){
		riskgradeStoreH.removeAll();
		 var da = [ [ '高风险', 'H' ],[ '中风险', 'M' ]];
		 riskgradeStoreH.loadData(da);
	...
	//var dqsh009= fxqLevelAuditPanel.form.findField("FXQ009").getValue();//	客户或其亲属、关系密切人是否属于外国政要           B            DQSH009
...
var tbar =[{
    text:'反洗钱风险等级审核',
    hidden:JsContext.checkGrant('_fxqdqsh_l'),
    handler:function(){
    	/**
    	 * 定期审核限制 上线开启
    	 */
    	/*var myDate = new Date();
    	var month = myDate.getMonth() + 1;//myDate.getMonth()获取到的是数组形式下标从0开始
    	if (!(myDate % 2 == 1 && (month == 10 || month == 9 || month == 11 || month == 12))) {
				    ...
				    items:[
				           {
				        	   ...
				        	   columnWidth : .48,
								...
								items :[
								        ...
								        ,{labelStyle:"padding-left:30px",allowBlank:false,xtype : 'combo',name : 'DQSH035',hiddenName : 'DQSH035',fieldLabel : '<font color="red">*</font>客户行为是否存在异常',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'
												,listeners : {
													select : function(n) {
								        ...
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH023',hiddenName : 'DQSH023',fieldLabel : '<font color="red">*</font>当前账户状态是否正常',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								       ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH009',hiddenName : 'DQSH009',fieldLabel : '<font color="red">*</font>账户是否频繁发生大额现金交易',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH032',hiddenName : 'DQSH032',fieldLabel : '<font color="red">*</font>账户资金交易频度、金额是否与其经营背景不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH029',hiddenName : 'DQSH029',fieldLabel : '<font color="red">*</font>账户是否与自然人账户之间发生频繁或大额的交易',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH030',hiddenName : 'DQSH030',fieldLabel : '<font color="red">*</font>账户是否存在分散转入集中转出或集中转入分散转出，且与经营背景、财务状况明显不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH015',hiddenName : 'DQSH015',fieldLabel : '<font color="red">*</font>账户资金是否快进快出，不留余额或少留余额',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH016',hiddenName : 'DQSH016',fieldLabel : '<font color="red">*</font>账户是否存在相同收付款人之间频繁发生交易，且金额接近大额交易标准',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH022',hiddenName : 'DQSH022',fieldLabel : '<font color="red">*</font>客户是否提前偿还贷款，且与其财务状况明显不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
				           ...
				           ,{
				        	   ...
				        	   columnWidth : .48,
								...
								items :[
								        ...
								        ,{labelStyle:"padding-left:30px",allowBlank:false,xtype : 'combo',name : 'DQSH036',hiddenName : 'DQSH036',fieldLabel : '<font color="red">*</font>账户交易是否存在异常',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'
												,listeners : {
													select : function(n) {
								        ...
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH031',hiddenName : 'DQSH031',fieldLabel : '<font color="red">*</font>账户是否频繁收取与其经营业务明显无关的汇款',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								          ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH033',hiddenName : 'DQSH033',fieldLabel : '<font color="red">*</font>账户交易对手及资金用途是否与其经营背景不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH017',hiddenName : 'DQSH017',fieldLabel : '<font color="red">*</font>账户是否长期闲置不明原因地突然启用，且短期内出现大量资金收付',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH018',hiddenName : 'DQSH018',fieldLabel : '<font color="red">*</font>账户是否平常资金流量小，突然有异常资金流入，且短期内出现大量资金收付',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH019',hiddenName : 'DQSH019',fieldLabel : '<font color="red">*</font>账户的跨境交易是否涉及贩毒、走私、恐怖活动、赌博严重地区或避税型离岸金融中心',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH034',hiddenName : 'DQSH034',fieldLabel : '<font color="red">*</font>账户是否与关联企业之间频繁发生大额交易',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden : true,labelStyle:"padding-left:30px",name : 'CURRENT_AUM', fieldLabel : 'AUM(人民币)',anchor : '90%',xtype: 'textfield'}
								...
								items :[
								        //以下为企业 隐藏数据
								         //,{name : 'FLAG_AGENT',fieldLabel : '客户标示',anchor : '90%',xtype: 'textfield',hidden : true}
								          ...
								          //,{name : 'FXQ008',fieldLabel : '客户标示',anchor : '90%',xtype: 'textfield',hidden : true}
								          //,{name : 'FXQ009',fieldLabel : '客户标示',anchor : '90%',xtype: 'textfield',hidden : true}
		    ...
		    items:[
		           ...
		           ,
		           {
		        	   columnWidth : .48,
						layout : 'form',
						items :[
								{labelStyle:"padding-left:30px",xtype : 'combo',name : 'FLAG_AGENT',hiddenName : 'FLAG_AGENT',fieldLabel : '客户是否是代理开户',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
			    ...
			    items:[
			           ...
			           ,{
			        	   columnWidth : .48,
							layout : 'form',
							items :[
							        {labelStyle:"padding-left:30px",xtype : 'combo',name : 'if_org_sub_type_per',hiddenName : 'if_org_sub_type_per',fieldLabel : '<font color="red">*</font>客户是否为自贸区客户',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
										mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%',readOnly:true,cls:'x-readOnly'}
									,{labelStyle:"padding-left:30px",allowBlank:false,xtype : 'combo',name : 'FXQ008',hiddenName : 'FXQ008',fieldLabel : '<font color="red">*</font>客户是否涉及风险提示信息或权威媒体报道信息',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
										mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'
											,listeners:{
			        	   ...
			        	   columnWidth : .8,
							...
							items :[
							        {labelStyle:"padding-left:30px",allowBlank:false,xtype : 'lovcombo',name : 'FXQ007',multi: true,multiSeparator:',',hiddenName : 'FXQ007',fieldLabel : '<font color="red">*</font>客户办理的业务',store : zlFXQ007Store,resizable : true,valueField : 'key',displayField : 'value',
							        	mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
//							        ,{hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'FLAG_AGENT',hiddenName : 'FLAG_AGENT',fieldLabel : '客户是否是代理开户',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
//											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%',cls:'x-readOnly',readOnly:true}
									]
			           }
				    ...
				    items:[
				           {
				        	   ...
				        	   columnWidth : .48,
								layout : 'form',
								items :[
					 					{labelStyle:"padding-left:30px",xtype : 'datefield',name : 'DQSH005',fieldLabel : '预计证件更新时间',format:'Y-m-d',anchor : '90%'
					 						,listeners: {
								        		change: function (n) { 
								        ...
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH010',hiddenName : 'DQSH010',fieldLabel : '<font color="red">*</font>账户是否频繁发生外币现钞存取业务',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
				    ...
				    items:[
				           {
				        	   ...
				        	   columnWidth : .48,
								layout : 'form',
								items :[
								        {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH011',hiddenName : 'DQSH011',fieldLabel : '<font color="red">*</font>账户现金交易是否与客户职业特性不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        ,{hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH013',hiddenName : 'DQSH013',fieldLabel : '<font color="red">*</font>账户是否与公司账户之间发生频繁或大额的交易',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH014',hiddenName : 'DQSH014',fieldLabel : '<font color="red">*</font>账户是否存在分散转入集中转出或集中转入分散转出，且与客户身份、财务状况明显不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH017',hiddenName : 'DQSH017',fieldLabel : '<font color="red">*</font>账户是否长期闲置不明原因地突然启用，且短期内出现大量资金收付',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								         , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH021',hiddenName : 'DQSH021',fieldLabel : '<font color="red">*</font>账户是否经常由他人代为办理业务',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH020',hiddenName : 'DQSH020',fieldLabel : '<font color="red">*</font>账户是否频繁发生跨境交易，且金额大于1万美元',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH019',hiddenName : 'DQSH019',fieldLabel : '<font color="red">*</font>账户的跨境交易是否涉及贩毒、走私、恐怖活动、赌博严重地区或避税型离岸金融中心',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
				           ...
				           ,{
				        	   ...
				        	   columnWidth : .48,
								layout : 'form',
								items :[
								        {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH012',hiddenName : 'DQSH012',fieldLabel : '<font color="red">*</font>账户是否频繁发生大额的网上银行交易',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH015',hiddenName : 'DQSH015',fieldLabel : '<font color="red">*</font>账户资金是否快进快出，不留余额或少留余额',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH018',hiddenName : 'DQSH018',fieldLabel : '<font color="red">*</font>账户是否平常资金流量小，突然有异常资金流入，且短期内出现大量资金收付',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH016',hiddenName : 'DQSH016',fieldLabel : '<font color="red">*</font>账户是否存在相同收付款人之间频繁发生交易，且金额接近大额交易标准',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH023',hiddenName : 'DQSH023',fieldLabel : '<font color="red">*</font>当前账户状态是否正常',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
											mode : 'local',forceSelection : true,triggerAction : 'all',anchor : '90%'}
								        , {hidden:true,labelStyle:"padding-left:30px",xtype : 'combo',name : 'DQSH022',hiddenName : 'DQSH022',fieldLabel : '<font color="red">*</font>客户是否提前偿还贷款，且与其财务状况明显不符',store : ifStore,resizable : true,valueField : 'key',displayField : 'value',
