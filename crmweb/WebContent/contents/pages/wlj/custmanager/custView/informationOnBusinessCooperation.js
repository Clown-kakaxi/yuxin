...
var fields=[
            ...
            {name:'FREEZE_AMOUNT',text:'冻结金额(折人民币)',xtype:'textfield',viewFn:money('0,000.00'),resutlFloat:'right',resutlWidth:100},
            {name:'ACCT_TYPE',text:'账户类别',translateType:'ACCOUNT_TYPE',resutlWidth:100},
			...
			{name:'RATE',text:'利率(%)',xtype:'textfield',resutlWidth:60},
			{name:'TRANS_TIMES',text:'转存次数',xtype:'textfield',gridField:false,resutlWidth:60}, 
            {name:'ACCT_NO1',text:'账号',xtype:'textfield',gridField:false,resutlWidth:60}
	...
	
{
	...
	title:'实时余额',// 存款账号
	type:'grid',
	url:basepath + '/accountQuery!perdeposit.json?CustId='+_custId,
	fields : {
		fields:[
