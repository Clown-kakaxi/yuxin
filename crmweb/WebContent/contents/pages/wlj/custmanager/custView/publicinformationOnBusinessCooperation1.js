...
var fields=[
	    ...
	    {name:'CURR_FORMERLY',text:'余额（原币种）',xtype:'textfield',viewFn:money('0,000.00'),gridField:false,resutlWidth:100},
	    {name:'AMOUNT',text:'余额（折人民币）',xtype:'textfield',viewFn:money('0,000.00'),resutlWidth:100},
	    {name:'SUBJECTS',text:'科目',resutlWidth:60,gridField:false},
	    {name:'CURRE_FIRM_INTEREST',text:'本年实收利息',xtype:'textfield',resutlFloat:'right',resutlWidth:80,gridField:false,viewFn:money('0,000.00')},
	    {name:'CURRE_MUST_INTEREST',text:'本年应收利息',xtype:'textfield',resutlWidth:80,gridField:false,viewFn:money('0,000.00')},
	    {name:'ACCOUNT_STAT',text:'账户状态',translateType:'XD000189',gridField:false,xtype:'textfield',resutlWidth:60},
	    {name:'LOAN_AVG_Y',text:'年日均',viewFn:money('0,000.00'),xtype:'textfield',resutlWidth:60},
	    {name:'FIVE_LEVEL_TYPE',text:'五级分类',xtype:'textfield',translateType:'DM0009',resutlWidth:60},
	    {name:'OPEN_ACCOUNT_DATE',text:'开户日期',xtype:'textfield',resutlWidth:100,gridField:false},
	    {name:'LOGOUT_ACCOUNT_DATE',text:'销户日期',xtype:'textfield',resutlWidth:60,gridField:false},
	    {name:'START_INTER_DATE',text:'起息日',xtype:'textfield',resutlWidth:60,gridField:false},
	    {name:'MATURE_DATE',text:'到期日',xtype:'textfield',resutlWidth:60,gridField:false},
	    {name:'LOAN_AVG_M',text:'月日均',xtype:'textfield',resutlWidth:60,gridField:false},
	    {name:'LOAN_AVG_Q',text:'季日均',xtype:'textfield',resutlWidth:60,gridField:false},
	    
	    {name:'RATE',text:'利率(%)',xtype:'textfield',resutlWidth:60,gridField:true},
	    {name:'BEF_DEGREE_CONTRI',text:'贡献度（模拟利润）',xtype:'textfield',resutlWidth:60,gridField:false},
	    {name:'ETL_DATE',text:'ETL日期',xtype:'textfield',resutlWidth:60,gridField:false}
    ];
...
//	title:'实时交易流水',
//	type:'grid',
//	url : basepath + '/accountQuery!trans.json?CustId='+_custId,
//	fields : {
//		fields:[
...
//},
	...
	title:'实时余额', //贷款账号
	type:'grid',
	url:basepath + '/accountQuery!Loan.json?CustId='+_custId,
	fields : {
		fields:[
...
//		accountNo=getSelectedData().data.ACCT_NO;
		theView.setParameters({
			accountNo:ids,
			curr:getSelectedData().data.MONEY_TYPE,
			flag:'jgls'
			});
	}
