...
<head>
	...
	var tabs =[{
		title:'机构存款账号信息',
		url:'/contents/pages/wlj/custmanager/custView/publicinformationOnBusinessCooperation.js'
	},{
		title:'机构贷款账号信息',
		url:'/contents/pages/wlj/custmanager/custView/publicinformationOnBusinessCooperation1.js'
	}];
	</script>
