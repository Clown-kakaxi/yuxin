...
<head>
	...
	var tabs =[{
		title:'存款账号信息',
		url:'/contents/pages/wlj/custmanager/custView/informationOnBusinessCooperation2.js'
	},{
		title:'贷款账号信息',
		url:'/contents/pages/wlj/custmanager/custView/informationOnBusinessCooperation1.js'
	}];
	</script>
