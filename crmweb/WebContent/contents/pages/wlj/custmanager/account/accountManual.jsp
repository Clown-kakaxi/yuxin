...
<script type="text/javascript"
	src="/crmweb/jQuery/js/jquery-1.11.3.min.js"></script>
...
<script type="text/javascript">
	...
	function initData() {
		if (openerInfo) {
			...
			var nationNality = openerInfo.nationNality; //民族
			var POST_ZIPCODE = openerInfo.POST_ZIPCODE;//居住地邮编
			var citizenShip = openerInfo.citizenShip;//国籍
			var birthday = openerInfo.birthday; //出生日
			var birthLocale = openerInfo.birthLocale;//出生地
			...
			var HOME_ADDR = openerInfo.HOME_ADDR;//居住地所属国籍
			var HOME_ADDR_INFO = openerInfo.HOME_ADDR_INFO;//居住地详细地址
			...
			var JOBNAME = openerInfo.JOBNAME;//单位名称
			var JOB = openerInfo.JOB; //职位
			var JOBREMARK = openerInfo.JOBREMARK; //职业备注
			var RELATEDNAME = openerInfo.RELATEDNAME; //关联人姓名
			var RELATION = openerInfo.RELATION; //与关联人关系
			var USTIN = openerInfo.USTIN; //US/TIN
			var SEX = openerInfo.SEX; //性别
			var isRent = openerInfo.isRent; //租赁自有
			var JOBINFO = openerInfo.JOBINFO;//工作性质
			var HASRELATED = openerInfo.HASRELATED;//有无关联人
			...
			var jiejika = openerInfo.jiejika; //借记卡
			var dianziBank = openerInfo.dianziBank; //电子银行
			var elecState = openerInfo.elecState; //电子对账单
			var chgNotice = openerInfo.chgNotice; //账务变动通知
			var cardType1_0 = openerInfo.cardType1_0; //金卡/白金卡/钻石卡/数位生活卡
			var cardType2_0 = openerInfo.cardType2_0; //普通卡/定制姓名卡/粉蓝/粉红
			var ATMDayLimitDefault = openerInfo.ATMDayLimitDefault;
			var ATMDayCountDefault = openerInfo.ATMDayCountDefault;
			var ATMYearLimitDefault = openerInfo.ATMYearLimitDefault;
			var POSDefault = openerInfo.POSDefault;
			var ATMDayLimitDefine = openerInfo.ATMDayLimitDefine;
			var ATMDayCountDefine = openerInfo.ATMDayCountDefine;
			var ATMYearLimitDefine = openerInfo.ATMYearLimitDefine;
			var POSDefine = openerInfo.POSDefine;
			var ATMDayLimit = openerInfo.ATMDayLimit;
			var ATMDayLimitCount = openerInfo.ATMDayLimitCount;
			var ATMYearLimit = openerInfo.ATMYearLimit;
			var eachCustemLimit = openerInfo.eachCustemLimit;
			var netBank = openerInfo.netBank;
			var ukey = openerInfo.ukey;
			var shortMessage = openerInfo.shortMessage;
			var phoneBank = openerInfo.phoneBank;
			var mobileBank = openerInfo.mobileBank;
			var shortMessage2 = openerInfo.shortMessage2;
			var dayAccLimitDefault = openerInfo.dayAccLimitDefault;
			var dayAccCountDefault = openerInfo.dayAccCountDefault;
			var yearAccLimitDefault = openerInfo.yearAccLimitDefault;
			var dayAccSelfDefine = openerInfo.dayAccSelfDefine;
			var dayCountSelfDefine = openerInfo.dayCountSelfDefine;
			var yearAccSelfDefine = openerInfo.yearAccSelfDefine;
			var Email1 = openerInfo.email;
			var isEquEmail = openerInfo.isEquEmail;
			...
			if (1 == 1) {
				...
				e_customerName.innerHTML = "&nbsp;<b>姓名：</b>" + custName;
				var e_customPinYin = document.getElementById("customPinYin");
				e_customPinYin.innerHTML = "&nbsp;<b>姓名拼音：</b>" + customPinYin;
				var e_POST_ZIPCODE = document.getElementById("POST_ZIPCODE");
				e_POST_ZIPCODE.innerHTML = "&nbsp;<b>居住地邮编：</b>" + POST_ZIPCODE;
				var e_citizenShip = document.getElementById("citizenShip");
				e_citizenShip.innerHTML = "&nbsp;<b>国籍：</b>" + citizenShip;
				var e_birthday = document.getElementById("birthday");
				e_birthday.innerHTML = "&nbsp;<b>出生日期：</b>" + birthday;
				var e_birthLocale = document.getElementById("birthLocale");
				e_birthLocale.innerHTML = "&nbsp;<b>出生地：</b>" + birthLocale;
				var e_identityType = document.getElementById("identityType");
				e_identityType.innerHTML = "&nbsp;<b>证件种类：</b>" + identityType;
				var e_identityNo = document.getElementById("identityNo");
				e_identityNo.innerHTML = "&nbsp;<b>证件号码：</b>" + identityNo;
				var e_tgIdentNum = document.getElementById("tgIdentNum");
				debugger;
				if (gaIdentNum3 != "") {
					e_tgIdentNum.innerHTML = "&nbsp;<b>港澳身份证号：</b>"
							+ gaIdentNum3;
				} else if (twIdentNum3 != "") {
					e_tgIdentNum.innerHTML = "&nbsp;<b>台湾身份证：</b>"
							+ twIdentNum3;
				} else if(identityType3mz != "5" || identityType3mz != "6" || identityType3mz != "X3" || identityType3mz != "X24"){
				...
				;
				var e_LEGAL_EXPIRED_DATE = document
						.getElementById("LEGAL_EXPIRED_DATE");
				e_LEGAL_EXPIRED_DATE.innerHTML = "&nbsp;<b>证件有效期：</b>"
						+ LEGAL_EXPIRED_DATE;
				debugger;
				var e_HOME_ADDR = document.getElementById("HOME_ADDR");
				e_HOME_ADDR.innerHTML = "&nbsp;<b>居住地址：</b>" + HOME_ADDR
						+ "&nbsp;" + HOME_ADDR_INFO;
				if (e_HOME_ADDR.innerHTML.length > 52){
					juzhudizhi.setAttribute("style","height:4em")
				};
				var e_MAIL_ADDR = document.getElementById("MAIL_ADDR");
				e_MAIL_ADDR.innerHTML = "&nbsp;<b>邮寄地址：</b>" + MAIL_ADDR
						+ "&nbsp;" + MAIL_ADDR_INFO;
				...
				e_EMAIL.innerHTML = "&nbsp;<b>电子邮箱E-mail：</b>" + EMAIL;
				var e_JOBNAME = document.getElementById("JOBNAME");
				e_JOBNAME.innerHTML = "&nbsp;<b>单位名称：</b>" + JOBNAME;
				var e_JOB = document.getElementById("div_JOB");
				e_JOB.innerHTML = "&nbsp;<b>职位：</b>" + JOB;
				var e_JOBREMARK = document.getElementById("JOBREMARK");
				e_JOBREMARK.innerHTML = "&nbsp;<b>其他（请具体注明）：</b>" + JOBREMARK;
				var e_RELATEDNAME = document.getElementById("RELATEDNAME");
				e_RELATEDNAME.innerHTML = "<b>（姓名：</b>" + RELATEDNAME;
				var e_RELATION = document.getElementById("RELATION");
				e_RELATION.innerHTML = "<b>关系：</b>" + RELATION + "<b> ）</b>";
				var e_USTIN = document.getElementById("USTIN");
				e_USTIN.innerHTML = "US/TIN：" + USTIN;
				var e_SEX1 = document.getElementById("SEX1");
				var e_SEX2 = document.getElementById("SEX2");
				if (SEX == '1') {
					e_SEX1.setAttribute("checked", "checked");
				} else if (SEX == '2') {
					e_SEX2.setAttribute("checked", "checked");
					;
				} else {
					e_SEX1.checked = false;
					e_SEX2.checked = false;
				}
				;
				var e_adress1 = document.getElementById("adress1");
				var e_adress2 = document.getElementById("adress2");
				if (isRent == '2') {
					adress1.setAttribute("checked", "checked");
					;
				} else if (isRent == '1') {
					adress2.setAttribute("checked", "checked");
					;
				} else {
					adress1.checked = false;
					adress2.checked = false;
				}
				;
				var e_job1 = document.getElementById("job1");
				var e_job2 = document.getElementById("job2");
				var e_job3 = document.getElementById("job3");
				var e_job4 = document.getElementById("job4");
				if (JOBINFO == '04') {
					e_job1.setAttribute("checked", "checked");
					e_JOBREMARK.innerHTML = "";
				} else if (JOBINFO == '05') {
					e_job2.setAttribute("checked", "checked");
					e_JOBNAME.innerHTML = "" ;
					e_JOB.innerHTML = "" ;
					e_JOBREMARK.innerHTML = "";
					document.getElementById("zhiyeziliao").setAttribute("class", "content-row-pro11");
				} else if (JOBINFO == '10') {
					e_job3.setAttribute("checked", "checked");
					e_JOBNAME.innerHTML = "" ;
					e_JOB.innerHTML = "" ;
					e_JOBREMARK.innerHTML = "";
					document.getElementById("zhiyeziliao").setAttribute("class", "content-row-pro11");
				} else if (JOBINFO == '99') {
					e_job4.setAttribute("checked", "checked");
					e_JOBNAME.innerHTML = "" ;
					e_JOB.innerHTML = "" ;
					document.getElementById("zhiyeziliao").setAttribute("class", "content-row-pro11");
				} else {
					e_job1.checked = false;
					e_job2.checked = false;
					e_job3.checked = false;
					e_job4.checked = false;
				}
				;
				var e_isGuanLian1 = document.getElementById("isGuanLian1");
				var e_isGuanLian2 = document.getElementById("isGuanLian2");
				if (HASRELATED == '1') {
					isGuanLian2.setAttribute("checked", "checked");
				} else if (HASRELATED == '0') {
					isGuanLian1.setAttribute("checked", "checked");
					e_RELATION.innerHTML = '';
					e_RELATEDNAME.innerHTML = '';
				} else {
					isGuanLian1.checked = false;
					isGuanLian2.checked = false;
				}
				;
				var taxData = [ {
					seq : 1,
				...
				var arr = [
						...
						'<thead>', '<th>序号</th>', '<th>税收居民国（地区）</th>',
						'<th>纳税人识别号（TIN）</th>', '</thead>', '<tbody>' ];
				...
				if (jnOrJwCategory == "D") {
					...
					for ( var i = 0; i < jnOrJwCheckbox.length; i++) {
						if (jnOrJwCheckbox[i] == 'H') {
							...
							e_jnOrJwCheckbox10.setAttribute("checked",
									"checked");
							;
						} else {
						}
				...
				;
				var e_jiejika = document.getElementById("jiejika");
				var e_dianziBank = document.getElementById("dianziBank");
				var e_elecState = document.getElementById("elecState");
				var e_chgNotice = document.getElementById("chgNotice");
				var e_leiji1 = document.getElementById("leiji1");
				var e_leiji2 = document.getElementById("leiji2");
				var e_leiji3 = document.getElementById("leiji3");
				var e_leiji4 = document.getElementById("leiji4");
				var e_leiji5 = document.getElementById("leiji5");
				var e_leiji6 = document.getElementById("leiji6");
				if (dianziBank == '1') {
					e_dianziBank.setAttribute("checked", "checked");
					;
					if (dayAccLimitDefault == '1') {
						e_leiji1.setAttribute("checked", "checked");
					} else {
						e_leiji2.setAttribute("checked", "checked");
					}
					;
					if (dayAccCountDefault == '1') {
						e_leiji3.setAttribute("checked", "checked");
					} else {
						e_leiji4.setAttribute("checked", "checked");
					}
					;
					if (yearAccLimitDefault == '1') {
						e_leiji5.setAttribute("checked", "checked");
					} else {
						e_leiji6.setAttribute("checked", "checked");
					}
					;
				} else {
					e_dianziBank.checked = false;
					leiji1.checked = false;
					leiji2.checked = false;
					leiji3.checked = false;
					leiji4.checked = false;
					leiji5.checked = false;
					leiji6.checked = false;
				}
				;
				if (elecState == '1') {
					e_elecState.setAttribute("checked", "checked");
					;
				} else {
				}
				;
				if (chgNotice == '1') {
					e_chgNotice.setAttribute("checked", "checked");
					;
				} else {
				}
				;
				var e_jka = document.getElementById("jka");
				var e_bjka = document.getElementById("bjka");
				var e_zska = document.getElementById("zska");
				var e_swshka = document.getElementById("swshka");
				var e_ptka1 = document.getElementById("ptka1");
				var e_ptka2 = document.getElementById("ptka2");
				var e_ptka3 = document.getElementById("ptka3");
				var e_dzxmka1 = document.getElementById("dzxmka1");
				var e_dzxmka2 = document.getElementById("dzxmka2");
				var e_dzxmka3 = document.getElementById("dzxmka3");
				var e_flka = document.getElementById("flka");
				var e_fhka = document.getElementById("fhka");
				if (jiejika == '1') {
					e_jiejika.setAttribute("checked", "checked");
					;
					if (cardType1_0 == '1') {
						e_jka.setAttribute("checked", "checked");
						;
						if (cardType2_0 == '1001') {
							e_ptka1.setAttribute("checked", "checked");
							;
						} else if (cardType2_0 == '1002') {
							e_dzxmka1.setAttribute("checked", "checked");
							;
						} else {
							e_ptka1.checked = false;
							e_dzxmka1.checked = false;
						}
					} else if (cardType1_0 == '2') {
						e_bjka.setAttribute("checked", "checked");
						;
						if (cardType2_0 == '1001') {
							e_ptka2.setAttribute("checked", "checked");
							;
						} else if (cardType2_0 == '1002') {
							e_dzxmka2.setAttribute("checked", "checked");
							;
						} else {
							e_ptka2.checked = false;
							e_dzxmka2.checked = false;
						}
					} else if (cardType1_0 == '3') {
						e_zska.setAttribute("checked", "checked");
						;
						if (cardType2_0 == '1001') {
							e_ptka3.setAttribute("checked", "checked");
							;
						} else if (cardType2_0 == '1002') {
							e_dzxmka3.setAttribute("checked", "checked");
							;
						} else {
							e_ptka3.checked = false;
							e_dzxmka3.checked = false;
						}
					} else if (cardType1_0 == '001') {
						e_swshka.setAttribute("checked", "checked");
						;
						if (cardType2_0 == '0011') {
							e_flka.setAttribute("checked", "checked");
							;
						} else if (cardType2_0 == '0012') {
							e_fhka.setAttribute("checked", "checked");
							;
						} else {
							e_flka.checked = false;
							e_fhka.checked = false;
						}
					} else {

						e_jka.checked = false;
						e_bjka.checked = false;
						e_zska.checked = false;
						e_swshka.checked = false;
						e_flka.checked = false;
						e_fhka.checked = false;
						e_ptka1.checked = false;
						e_dzxmka1.checked = false;
				...
				;
				var e_atm01 = document.getElementById("atm01");
				var e_atm02 = document.getElementById("atm02");
				var e_atm03 = document.getElementById("atm03");
				var e_atm04 = document.getElementById("atm04");
				var e_atm05 = document.getElementById("atm05");
				var e_atm06 = document.getElementById("atm06");
				var e_atm07 = document.getElementById("atm07");
				var e_atm08 = document.getElementById("atm08");
				if (jiejika == '1') {
					if (ATMDayLimitDefault == '1') {
						e_atm01.setAttribute("checked", "checked");
						;
					} else {
						e_atm02.setAttribute("checked", "checked");
						;
					}
					;
					if (ATMDayCountDefault == '1') {
						e_atm03.setAttribute("checked", "checked");
						;
					} else {
						e_atm04.setAttribute("checked", "checked");
						;
					}
					;
					if (ATMYearLimitDefault == '1') {
						e_atm05.setAttribute("checked", "checked");
						;
					} else {
						e_atm06.setAttribute("checked", "checked");
						;
					}
					;
					if (POSDefault == '1') {
						e_atm07.setAttribute("checked", "checked");
						;
					} else {
						e_atm08.setAttribute("checked", "checked");
						;
					}
					;
				} else {
					e_atm01.checked = false;
					e_atm02.checked = false;
					e_atm03.checked = false;
					e_atm04.checked = false;
					e_atm05.checked = false;
					e_atm06.checked = false;
					e_atm07.checked = false;
					e_atm08.checked = false;
				}
				var e_atm1 = document.getElementById("div_atm1");
				var e_atm2 = document.getElementById("div_atm2");
				var e_atm3 = document.getElementById("div_atm3");
				var e_atm4 = document.getElementById("div_atm4");
				if (e_atm02.checked == true) {
					e_atm1.innerHTML = "每日累计转账最高限额RMB  " + ATMDayLimit
							+ "  元(0-50,000元)";
				} else {
					e_atm1.innerHTML = "每日累计转账最高限额RMB________元(0-50,000元)";
				}
				;
				if (e_atm04.checked == true) {
					e_atm2.innerHTML = "每日累计转账笔数  " + ATMDayLimitCount + "  笔";
				} else {
					e_atm2.innerHTML = "每日累计转账笔数________笔";
				}
				;
				if (e_atm06.checked == true) {
					e_atm3.innerHTML = "每年累计转账最高限额RMB  " + ATMYearLimit + "  元";
				} else {
					e_atm3.innerHTML = "每年累计转账最高限额RMB________元";
				}
				;
				if (e_atm08.checked == true) {
					e_atm4.innerHTML = "单笔消费限额RMB  " + eachCustemLimit + "  元";
				} else {
					e_atm4.innerHTML = "单笔消费限额RMB________元";
				}
				;
				var e_netBank = document.getElementById("netBank");
				var e_ukey = document.getElementById("ukey");
				var e_shortMessage = document.getElementById("shortMessage");
				var e_phoneBank = document.getElementById("phoneBank");
				var e_mobileBank = document.getElementById("mobileBank");
				var e_shortMessage2 = document.getElementById("shortMessage2");
				if (netBank == '1') {
					e_netBank.setAttribute("checked", "checked");
					;
					if (ukey == '1') {
						e_ukey.setAttribute("checked", "checked");
						;
					} else {
					}
					;
					if (shortMessage == '1') {
						e_shortMessage.setAttribute("checked", "checked");
						;
					} else {
					}
					;
					...
					e_netBank.checked = false;
					e_ukey.checked = false;
					e_shortMessage.checked = false;
				}
				;
				
				if (mobileBank == '1') {
					e_mobileBank.setAttribute("checked", "checked");
					;
					if (shortMessage2 == '1') {
						e_shortMessage2.setAttribute("checked", "checked");
						;
					} else {
					}
					;
				} else {
					e_mobileBank.checked = false;
					e_shortMessage2.checked = false;
				}
				;
				var e_zidingyi1 = document.getElementById("zidingyi1");
				var e_zidingyi2 = document.getElementById("zidingyi2");
				var e_zidingyi3 = document.getElementById("zidingyi3");
				if (e_leiji2.checked == true) {
					e_zidingyi1.innerHTML = "自定义 " + dayAccSelfDefine + " 元";
				} else {
					e_zidingyi1.innerHTML = "自定义______元";
				}
				;
				if (e_leiji4.checked == true) {
					e_zidingyi2.innerHTML = "自定义 " + dayCountSelfDefine + " 笔";
				} else {
					e_zidingyi2.innerHTML = "自定义______元";
				}
				;
				if (e_leiji6.checked == true) {
					e_zidingyi3.innerHTML = "自定义 " + yearAccSelfDefine + " 元";
				} else {
					e_zidingyi3.innerHTML = "自定义______元";
				}
				;
			...
			$.ajax({
				...
				success : function(result) {
					...
					if (result.msg) {
						...
						if (wordHtml.indexOf("<style") > -1
								&& wordHtml.indexOf("</style>") > -1) {
...
<body onbeforePrint="beforePrint()" onafterprint="afterPrint()">
	<div style="text-align: center" id='PrintButton'>
		<br />
		<object ID='WebBrowser' WIDTH=0 HEIGHT=0 border=1
			style="display: none"
			...
			<div id="custContent" class="document">
				<ul>
					...
					<li class="content-row">
						<div id="customerName" class="customer-detail"
							style="border-left-width: 0;"><b>姓名：</b></div>
						<div class="customer-detail" id="customPinYin"><b>姓名拼音：</b></div>
						<div class="customer-detail">
							&nbsp;<b>性别：</b>&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox"
								class='c2' disabled="disabled" name="sex" id="SEX1" value="1">&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled" name="sex"
								id="SEX2" value="2">&nbsp;女
						</div>
					</li>
					<li class="content-row">
						<div id="birthday" class="customer-detail"
							style="border-left-width: 0;"><b>出生日期：</b></div>
						<div id="citizenShip" class="customer-detail"><b>国籍：</b></div>
						<div id="birthLocale" class="customer-detail"><b>出生地：</b></div>
					</li>
					<li class="content-row">
						<div id="identityType" class="customer-detail"
							style="border-left-width: 0;"><b>证件种类：</b></div>
						<div id="identityNo" class="customer-detail"><b>证件号：</b></div>
						<div id="LEGAL_EXPIRED_DATE" class="customer-detail"><b>证件有效期：</b></div>
					</li>
					<li id = "tg" class="content-row"><span id="tgIdentNum"><b>台湾身份证/港澳身份证号：</b></span></li>
					<li id = "juzhudizhi" class="content-row">
						<div
							style="border-right: 1px black solid; width: 70%; height: 100%; float: left;">
							<div id="HOME_ADDR" style="width: 75%; float: left;">居住地址：</div>
							<div style="width: 20%; float: left;">
								<input type="checkbox" class='c2' disabled="disabled"
									name="adress" id="adress1" value="1">&nbsp;租赁&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="checkbox" class='c2' disabled="disabled"
									name="adress" id="adress2" value="2">&nbsp;自有
							</div>
						</div>
						<div id=POST_ZIPCODE style="width: 29%; float: left;">居住地邮编：
						</div>
					</li>
					<li class="content-row">
						<div id="MAIL_ADDR"
							style="width: 70%; float: left; border-right: 1px black solid;">邮寄地址：</div>
						<div id="MAIL_ZIPCODE" style="width: 29%; float: left;">邮寄邮编：</div>
					</li>
					<li id="mbPHONENUM" class="content-row">移动电话：
						<div style="width: 50%; float: right;">（此电话将用于接收短信验证码和账务变动通知）</div>
					</li>
					<li  id = "zhiyeziliao" class="content-row-pro1"><b>&nbsp;职业资料</b><br />
						<div style="width: 50%; float: left;">
							&nbsp;<input type="checkbox" class='c2' disabled="disabled"
								name="job" id="job1" value="全日制雇员">&nbsp;全日制雇员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled" name="job"
								id="job2" value="自雇">&nbsp;自雇&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled" name="job"
								id="job3" value="退休">&nbsp;退休&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled" name="job"
						...
						<div id="JOBREMARK" style="width: 50%; float: left;">（请具体注明）___________________________________________
						</div>
						<br />
						<div id="JOBNAME" style="width: 50%; float: left;">单位名称：</div>
						<div id="div_JOB" style="width: 50%; float: left;">职位：</div></li>
					<li id="EMAIL" class="content-row"><b>电子邮箱E-mail：</b></li>
					<div style="width: 35%; float: left;">
						<li class="content-row">&nbsp;<b>是否在我行有关联人： </b><input
							type="checkbox" class='c2' disabled="disabled" name="isGuanLian"
							id="isGuanLian1" value="0">&nbsp;否&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled"
							name="isGuanLian" id="isGuanLian2" value="1">&nbsp;是
						</li>
					</div>
					<li class="content-row"><div id="RELATEDNAME"
							style="width: 30%; float: left;"><b>（姓名：______________________</b></div>
						<div id="RELATION" style="width: 35%; float: left;"><b>关系：______________________）</b></div></li>
					<li class="content-row-pro1">
						<div>
							<b>&nbsp本人声明：</b>
						</div>
						<div>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
								type="checkbox" class='c2' disabled="disabled" name="shengMing"
								id="shengMing1" value="1">&nbsp;1、仅为中国税收居民&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled"
								name="shengMing" id="shengMing2" value="2">&nbsp;2、仅为非居民<br />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
								type="checkbox" class='c2' disabled="disabled" name="shengMing"
								id="shengMing3" value="3">&nbsp;3、既是中国税收居民又是其他国家（地区）税收居民&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
					</li>
					<li class="content-row"><b>&nbsp;如您在以上选项中勾选第2项或者第3项，请填写下列信息：</b></li>
					<li class="">
						<div style="width: 35%; float: left;">
							<b>1）是否为美国纳税人：</b> <input type="checkbox" class='c2'
								disabled="disabled" name="isNaShui" id="isNaShui1" value="1">&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="checkbox" class='c2' disabled="disabled"
								name="isNaShui" id="isNaShui2" value="2">&nbsp;否
						</div> <b><div id="USTIN" style="width: 65%; float: left;">（US
								TIN/SSN：________________________）</div></b>
						<div>
						...
						<div>
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="isNaShui" id="reason1" value="1">&nbsp;居民国（地区）不发放纳税人识别号<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="isNaShui" id="reason2" value="2">&nbsp;账户持有人未能取得纳税人识别号，如选此项，请解释具体原因：
					...
					<li class="content-row-pro10">
						<div style="width: 50%; float: left;">
							<b>&nbsp;境内客户：</b><br /> &nbsp;<input type="checkbox" class="c2"
								disabled="disabled" name="jingnei" id="jingnei1" value="一般综合账户">&nbsp;一般综合账户<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="jingnei" id="jingnei2" value="外汇结算户">&nbsp;外汇结算户<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="jingnei" id="jingnei4" value="外汇境内资产变现账户">&nbsp;外汇境内资产变现账户
						</div>
						<div
							style="width: 49%; float: left; border-left: 1px black solid;">
							<b>&nbsp;境外客户：</b><br /> &nbsp;<input type="checkbox" class="c2"
								disabled="disabled" name="jingwai" id="jingwai1" value="一般综合账户">&nbsp;一般综合账户<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="jingwai" id="jingwai2" value="外汇结算户">&nbsp;外汇结算户<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="jingwai" id="jingwai4" value="外汇境内资产变现账户">&nbsp;港澳居民人民币储蓄账户<br />
							&nbsp;<input type="checkbox" class="c2" disabled="disabled"
								name="jingwai" id="jingwai6" value="人民币再投资专用结算账户">&nbsp;人民币再投资专用结算账户
						</div>
					...
					<li class="content-row-pro5">
						<div>
							&nbsp;<input type="checkbox" class='c2' disabled="disabled"
								name="bservice" id="jiejika" value=""><b>&nbsp;借记卡申请</b><br />
						</div>
						<div>
							&nbsp;基础卡片&nbsp;&nbsp; <input type="checkbox" class='c2'
								disabled="disabled" name="jichu" id="jka" value="基础卡片">
							金卡 （<input type="checkbox" class='c2' disabled="disabled"
								name="jichu1" id="ptka1" value="普通卡"> 普通卡&nbsp; <input
								type="checkbox" class='c2' disabled="disabled" name="jichu1"
								id="dzxmka1" value="定制姓名卡"> 定制姓名卡）
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <input type="checkbox" class='c2'
								disabled="disabled" name="jichu" id="bjka" value="白金卡">
							白金卡 （<input type="checkbox" class='c2' disabled="disabled"
								name="jichu1" id="ptka2" value="普通卡"> 普通卡&nbsp; <input
								type="checkbox" class='c2' disabled="disabled" name="jichu1"
								id="dzxmka2" value="定制姓名卡"> 定制姓名卡）<input
								type="checkbox" class='c2' disabled="disabled" name="jichu"
								id="zska" value="钻石卡" style='margin-left: 55px'> 钻石卡 （<input
								type="checkbox" class='c2' disabled="disabled" name="jichu1"
								id="ptka3" value="普通卡"> 普通卡&nbsp; <input type="checkbox"
								class='c2' disabled="disabled" name="jichu1" id="dzxmka3"
								value="定制姓名卡"> 定制姓名卡）
						</div>
						<div>
							&nbsp;特色卡片&nbsp;&nbsp; <input type="checkbox" class='c2'
								disabled="disabled" name="jichu" id="swshka" value="数位生活卡">
							数位生活卡 （<input type="checkbox" class='c2' disabled="disabled"
								name="jichu1" id="flka" value="粉蓝"> 粉蓝&nbsp; <input
								type="checkbox" class='c2' disabled="disabled" name="jichu1"
								id="fhka" value="粉红"> 粉红）
						</div>
						<div>
							<table style="width: 100%;">
								<tr>
									<td>&nbsp;ATM转账限额设置</td>
									<td><input type="checkbox" class='c2' disabled="disabled"
										name="atm1" id="atm01" value="1">&nbsp;默认每日累计限额(RMB50,000元)&nbsp;&nbsp;&nbsp;
										<input type="checkbox" class='c2' disabled="disabled"
										name="atm1" id="atm02" value="2" style="margin-left: 30px;">
										<span id="div_atm1" style="width: 52%;">每日累计转账最高限额RMB________元(0-50,000元)</span><br />
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td><input type="checkbox" class='c2' disabled="disabled"
										name="atm2" id="atm03" value="3">&nbsp;默认每日累计笔数(10笔) <input
										type="checkbox" class='c2' disabled="disabled" name="atm2"
										id="atm04" value="4" style="margin-left: 92px;"> <span
										id="div_atm2" style="width: 58%;">每日累计转账笔数___________笔</span><br />
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
									<td><input type="checkbox" class='c2' disabled="disabled"
										name="atm3" id="atm05" value="5">&nbsp;默认每年累计限额(RMB10,000,000元)
										<input type="checkbox" class='c2' disabled="disabled"
										name="atm3" id="atm06" value="6" style="margin-left: 17px;">
										<span id="div_atm3" style="width: 47%;">每年累计转账最高限额RMB___________元</span><br />
									</td>
								</tr>
								<tr>
									<td>&nbsp;POS消费限额设置</td>
									<td><input type="checkbox" class='c2' disabled="disabled"
										name="atm4" id="atm07" value="7">
										&nbsp;默认单笔限额(RMB500,000元) <input type="checkbox" class='c2'
										disabled="disabled" name="atm4" id="atm08" value="8"
										style="margin-left: 55px;"> <span id="div_atm4"
										style="width: 53%;">单笔消费限额RMB________元</span></td>
								</tr>
							</table>
						</div>

					</li>
					<div class="content-row-pro10">
						<div
							style="width: 19.8%; height: 99.8%; border-bottom: 1px solid black; border-right: 1px black solid; float: left;">
							<br /> <br /> <br /> <br /> &nbsp;<input type="checkbox"
								class='c2' disabled="disabled" name="bservice" id="dianziBank" /><b>&nbsp;电子银行服务</b>
						</div>
						<div
							style="width: 80%; height: 99.8%; border-bottom: 1px solid black; float: right">
							<div
								style="width: 100%; height: 50%; border-bottom: 1px solid black;">
								<div
									style="width: 100%; height: 66%; border-bottom: 1px solid black">
									<div
										style="width: 19.8%; height: 100%; border-right: 1px black solid; float: left;">
										<br /> &nbsp;<input class='c2' type="checkbox"
											disabled="disabled" name="dianzi" id="netBank" value="网络银行" />&nbsp;网络银行
									</div>
									<div style="width: 80%; float: right; height: 100%;">
										<div
											style="width: 100%; height: 49.8%; border-bottom: 1px solid black;">
											&nbsp;<input type="checkbox" class='c2' disabled="disabled"
												name="dianzi" id="ukey" value="U-key认证" /> U-key认证<br />
										</div>
										<div style="width: 100%; height: 50%;">
											&nbsp;<input type="checkbox" class='c2' disabled="disabled"
												name="dianzi" id="shortMessage" value="短信验证" /> 短信验证
										</div>
									</div>
								</div>


								<div style="width: 100%; height: 33.9%;">
										<div
											style="width: 19.8%; height: 100%; border-right: 1px black solid; float: left">
											&nbsp;<input type="checkbox" class='c2' disabled="disabled"
												name="dianzi" id="mobileBank" value="手机银行" /> 手机银行
										</div>
										<div style="width: 80%; height: 100%; float: left">
											 <input type="checkbox" class='c2' disabled="disabled"
												name="dianzi" id="shortMessage2" style="margin-left: 5px;" /> 短信验证
										</div>
								</div>
							...
							<div style="width: 100%; height: 49.9%;">
								<div style="width: 100%; margin-top: 5px;">
									<span>&nbsp;每日累计转账限额&nbsp;&nbsp;&nbsp;&nbsp; <input
										type="checkbox" class='c2' disabled="disabled" name="leiji1"
										id="leiji1" value="默认无限制">&nbsp;默认无限制
										&nbsp;&nbsp;&nbsp;&nbsp; <span style="padding-left: 20px;">
											<input type="checkbox" class='c2' disabled="disabled"
											name="leiji1" id="leiji2" value="自定义">
									</span>
									</span> <span id="zidingyi1">自定义______元</span>
								</div>
								<div style="width: 100%; margin-top: 2px;">
									<span>&nbsp;每日累计转账笔数&nbsp;&nbsp;&nbsp;&nbsp; <input
										type="checkbox" class='c2' disabled="disabled" name="leiji2"
										id="leiji3" value="默认200笔">&nbsp;默认200笔
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
										style="padding-left: 20px;"> <input type="checkbox"
											class='c2' disabled="disabled" name="leiji2" id="leiji4"
											value="自定义">
									</span>
									</span> <span id="zidingyi2">自定义______笔</span>
								</div>
								<div style="width: 100%; margin-top: 2px;">
									<span>&nbsp;每年累计转账限额&nbsp;&nbsp;&nbsp;&nbsp; <input
										type="checkbox" class='c2' disabled="disabled" name="leiji3"
										id="leiji5" value="默认无限制">&nbsp;默认无限制
										&nbsp;&nbsp;&nbsp;&nbsp; <span style="padding-left: 20px;">
											<input type="checkbox" class='c2' disabled="disabled"
											name="leiji3" id="leiji6" value="自定义">
									</span> <span id="zidingyi3">自定义______元</span>
									</span>
								</div>
							</div>
						</div>
					...
					<div
						...
						&nbsp;<input type="checkbox" class='c2' disabled="disabled"
							name="adress" id="elecState" value=""><b> 电子对账单
							E-mail：</b>&nbsp; <span id="elEmail">_________________________</span>（
						<input type="checkbox" class='c2' disabled="disabled"
							name="isEquemail" id="isEquemail" value="同邮件地址"><b>
							同邮件地址</b>）
					...
					<div
						style="width: 100%; height: 2em; border-bottom: 1px solid black;">
						&nbsp;<input type="checkbox" class='c2' disabled="disabled"
							name="adress" id="chgNotice" value="账务变动通知 "><b>
							账务变动通知</b>
					</div>
				</ul>
			</div>
		...
		<div style="border: none; margin: 0 auto; width: 640pt">
			...
			<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
				...
				<tr style='mso-yfti-irow: 26; height: 29.7pt'>
					<td width=630 colspan=11 valign=top
						style='width: 640pt; border-top: none; border-left: solid windowtext 1.0pt; border-bottom: solid windowtext 0.5pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt; mso-border-bottom-alt: solid windowtext 1.5pt; background: transparent; padding: 0cm 5.4pt 0cm 5.4pt; height: 29.7pt;'>
						<p class=MsoNormal
				...
				<tr style='mso-yfti-irow: 28; page-break-inside: avoid;'>
					<td width=610pt colspan=11
						...
						<table style="width: 610pt; border: solid windowtext 0.0pt;">
							<tr>
								<td width="1%" style="vertical-align: top;"><b><span
										lang=EN-US
								...
								<td><b><span lang=EN-US
										style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>美国纳税居民是指根据相关法规及税收协定，在美国负有纳税义务的个人。主要包括具有美国国籍，或持有美国绿卡或在<u>美国长期逗留的自然人<span
							...
							<tr>
								<td width="1%" style="vertical-align: top;"><b><span
										...
										style='line-height: 155%; font-size: 10.5pt; font-family: 宋体;'><span
											style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span></b></td>
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 155%; font-family: 宋体'><b>若身份声明与客户所填信息冲突，请完成以下部分：</b>If&nbsp;U.S.
										Status. Declaration is conflict with other information, please
										complete following part:<span
										style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span></td>
							</tr>
							<tr>
								<!-- <td colspan="2">&nbsp;</td> -->
							...
							<tr>
								...
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>I
										certify that I am a tax resident of__________(country)，for the
										following reason:<span style='font: 7.0pt "Times New Roman"'>&nbsp;
									</span>
								</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>Was
										...
										citizenship ( Please provide Certificate of Loss of
										Nationality of the United States)<span
										style='font: 7.0pt "Times New Roman"'>&nbsp; </span>
								</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>□预留地址为美国地址&nbsp;U.S.
										address<span style='font: 7.0pt "Times New Roman"'>&nbsp;
									</span>
								</span></td>
							</tr>
							<tr>
								...
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>□预留电话为美国电话&nbsp;U.S.
										phone number<span style='font: 7.0pt "Times New Roman"'>&nbsp;
									</span>
								</span></td>
							</tr>
							<tr>
								<td width="1%" style="vertical-align: top;"><b><span
										...
										style='line-height: 150%; font-size: 10.5pt; font-family: 宋体;'><span
											style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span></b></td>
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>□出生地为美国&nbsp;U.S.
										place of birth<span style='font: 7.0pt "Times New Roman"'>&nbsp;
									</span>
								</span></td>
							</tr>
							<tr>
								<td width="1%" style="vertical-align: top;"><b><span
										...
										style='line-height: 150%; font-size: 10.5pt; font-family: 宋体;'><span
											style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span></b></td>
								<td><span lang=EN-US
									style='font-size: 10.5pt; line-height: 150%; font-family: 宋体'>□其他，请详细说明&nbsp;Other,
										please specify:_____________________________________<span
										style='font: 7.0pt "Times New Roman"'>&nbsp; </span>
								</span></td>
							</tr>
							<tr>
			...
			<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
				...
				<tr style='page-break-inside: avoid; height: 26.9pt'>
					<td width=650 colspan=12
						style='width: 640pt; border-top: solid windowtext 1.0pt; border-left: solid windowtext 1.0pt; border-bottom: solid windowtext 1pt; border-right: solid windowtext 1.0pt; background: #4BACC6; padding: 0cm 5.4pt 0cm 5.4pt; height: 23pt'>
						<p class=MsoNormalCxSpMiddle
							style='line-height: 115%; layout-grid-mode: char'>
							<b><span
								style='font-size: 16.0pt; line-height: 110%; font-family: 宋体'>客户声明及阅知</span></b>
						</p>
					</td>
				</tr>

				<tr style='page-break-inside: avoid; height: 240pt'>
					<td width=650 colspan=12 valign=top
						style='width: 640pt; border: solid windowtext 1.0pt; border-top: none; background: transparent; padding: 0cm 5.4pt 0cm 5.4pt; height: 256.25pt'>

						<table style="width: 610pt; border: solid windowtext 0.0pt;">
							<br />
							<tr>
								<td width="1%" style="vertical-align: top;"><span
									lang=EN-US
  ...
  style='font:7.0pt "Times New Roman"'>&nbsp; </span></span></td>
							...
							<tr>
								<td width="1%" style="vertical-align: top"><span lang=EN-US
									style='line-height: 128%; font-size: 10.5pt; font-family: 宋体;'>7.<span
										style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span></td>
								<td><b><span lang=EN-US
										style='font-size: 11.5pt; line-height: 128%; font-family: 宋体'>本人授权贵行根据有关协议及规定对本人提供的个人信息及资料进行核查、使用和披露，包括但不限于为提供有关服务之目的，
											将本人客户资料披露给贵行认为必需的第三方，包括但不限于贵行分支机构、关联机构、贵行的服务机构、增值产品（服务）提供商、代理人、外包作业机构、联名合作方以及相关资信机构。本人同意，贵行在进行其他产品和服务的销售时可使用本人信息及资料，法律法规另有规定的除外。本人理解并知晓本人作出该等授权的可能后果。<span
											style='font: 7.0pt "Times New Roman"'>&nbsp; </span>
									</span></b></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="1%" style="vertical-align: top; padding-top: 8px;"
									colspan="2"><span lang=EN-US
						...
						<p class=MsoNormalCxSpFirst
							style='line-height: 128%; layout-grid-mode: char'>
							<b> <span
								style='font-size: 10.5pt; line-height: 128%; font-family: 宋体'>客户签章
									<!-- （下列签章共<span
  lang=EN-US>&nbsp;&nbsp; </span>式凭<span lang=EN-US>&nbsp;&nbsp; </span>式有效） -->
						...
						<p>
							<span
								style='font-size: 10.5pt; line-height: 128%; font-family: 宋体; padding-left: 3px;'>日期：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;日</span>
 ...
 <span  style='font-size:10.5pt;line-height:128%;font-family:宋体;padding-left:330px;'>日期：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;日</span>
  ...
  -->
				...
				<tr style='page-break-inside: avoid; height: 36pt'>
					<td width=650 colspan=12 valign=top
						style='width: 640pt; border: solid windowtext 1.0pt; border-top: none; background: transparent; padding: 0cm 5.4pt 0cm 5.4pt; height: 30.6pt'>
						<p class=MsoNormalCxSpLast
							style='line-height: 9.0pt; layout-grid-mode: char; padding-top: 3px;'>
							<span style='font-size: 11.0pt; font-family: 宋体'>本人确认已领取<br />
							<br /></span>
						</p>
						<p class=MsoListParagraphCxSpFirst
							style='margin-left: 18.0pt; text-indent: -18.0pt; line-height: 7pt; layout-grid-mode: char'>
							<span lang=EN-US style='font-family: 楷体'>□<span
								style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span><span
								style='font-size: 11.0pt; font-family: 宋体'>借记卡<span
								lang=EN-US>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>卡号：<span
								lang=EN-US>___________________________<br />
								<br />
							</span></span>
						</p>
						<p class=MsoListParagraphCxSpMiddle
							...
							<span lang=EN-US style='font-family: 楷体'>□<span
								style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span><span
								style='font-size: 11.0pt; font-family: 宋体'>网络/手机银行密码函<br />
							<br /></span>
						</p>
						<p class=MsoListParagraphCxSpMiddle
							style='margin-left: 18.0pt; text-indent: -18.0pt; line-height: 7pt; layout-grid-mode: char'>
							<span lang=EN-US style='font-family: 楷体'>□<span
								style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span><span
								style='font-size: 11.0pt; font-family: 宋体'>电话银行密码函<br />
							<br /></span>
						</p>
						<p class=MsoListParagraphCxSpMiddle
							style='margin-left: 18.0pt; text-indent: -18.0pt; line-height: 7pt; layout-grid-mode: char'>
							<span lang=EN-US style='font-family: 楷体'>□<span
								style='font: 7.0pt "Times New Roman"'>&nbsp; </span></span><span
								style='font-size: 11.0pt; font-family: 宋体'>U-Key</span>
						</p>
						<p class=MsoListParagraphCxSpLast
							style='margin-left: 18.0pt; text-indent: 0cm; line-height: 9pt; layout-grid-mode: char; margin-bottom: 6pt;'>
							<span lang=EN-US style='font-size: 11.0pt; font-family: 宋体'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</span><span style='font-size: 11.0pt; font-family: 宋体;'>领取人签署：<span
								lang=EN-US>___________________________ </span></span>
						</p>
					</td>
				</tr>
				<!--<tr style='page-break-inside:avoid;height:36pt'>
  ...
  line-height:9pt;layout-grid-mode:char;margin-bottom:6pt;'></p>
			...
			<div style="align: center; width: 640pt; padding-top: 4px;">
				<p class=MsoNormal align=left style='text-align: left'>
					<span style='font-size: 11.0pt; font-family: 宋体'>业务经办：</span><span
						lang=EN-US style='font-size: 11.0pt'>&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
						style='font-size: 11.0pt; font-family: 宋体'>作业经办：</span><span
						lang=EN-US style='font-size: 11.0pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
						style='font-size: 11.0pt; font-family: 宋体'>作业主管：</span><span
		...
		<div style="text-align: center" id='PrintButton1'>
			<br />
			<object ID='WebBrowser1' WIDTH=0 HEIGHT=0 border=1
				style="display: none"
				CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'> </object>
