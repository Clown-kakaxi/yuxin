...
var fields = [{name:"ID",text:'id',gridField:false},
              ...
              {name:'JOIN_PERSON',text:'本次参与人员',hidden:true,maxLength:50},
              ...
              {name:'RES_CUSTSOURCE',text:'客户来源',hidden:true,translateType:'CUST_SOURCE',editable:true},
              {name:'RES_CASEBYPERSON',text:'转介人姓名',hidden:true,maxLength:20},
              {name:'RES_CASEBYPTEL',text:'转介人电话',hidden:true,maxLength:20},
              
              {name:'DCRB_MAJORSHOLDER',text:'主要股东补充说明',xtype:'textarea',hidden:true,maxLength:500},
              ...
              {name:'DCRB_PROFIT',text:'获利补充说明',xtype:'textarea',hidden:true,maxLength:500},
...
var tbar = [{
	text:'删除',
	hidden:JsContext.checkGrant('mktVisitInfoDelete'),
	handler : function(){
	...
	text:'新增',
	hidden:JsContext.checkGrant('mktVisitInfoCreate'),
	handler : function(){
		showCustomerViewByIndex(0);
	}
},{
	text:'CALLREPORT维护',
	hidden:JsContext.checkGrant('mktVisitInfoEdit'),
	handler : function(){
	...
	text:'详情',
	hidden:JsContext.checkGrant('mktVisitInfoDetail'),
	handler : function(){
	    if(getSelectedData() == false){
			Ext.Msg.alert('提示','请选择一条数据');
			return false;
...
var customerView = [{
	...
	groups : [{
		...
		}},'MGR_NAME','INTERVIEWEE_NAME','INTERVIEWEE_POST','INTERVIEWEE_PHONE','VISIT_TIME','TASK_TYPE','VISIT_TYPE','ID','REVIEW_STATE','TASK_NUMBER','MGR_ID'],
		fn:function(CUST_NAME,MGR_NAME,INTERVIEWEE_NAME,INTERVIEWEE_POST,INTERVIEWEE_PHONE,VISIT_TIME,TASK_TYPE,VISIT_TYPE,ID,REVIEW_STATE,TASK_NUMBER,MGR_ID){
			MGR_ID.hidden = true;
			TASK_TYPE.hidden = true;
			ID.hidden = true;
			REVIEW_STATE.hidden = true;
			TASK_NUMBER.hidden = true;
			return [CUST_NAME,MGR_NAME,INTERVIEWEE_NAME,INTERVIEWEE_POST,INTERVIEWEE_PHONE,VISIT_TIME,TASK_TYPE,VISIT_TYPE,ID,REVIEW_STATE,TASK_NUMBER,MGR_ID];
		}
	},{
		   columnCount : 0.95,
		   fields:[{name:'JOIN_PERSON',text:'本次参与人员',xtype:'textarea',maxLength:50}],
...
},
{
	...
	groups : [{
		columnCount : 2,
		fields:['MGR_ID','CUST_NAME','MGR_NAME','INTERVIEWEE_NAME','INTERVIEWEE_POST','INTERVIEWEE_PHONE','VISIT_TIME','CALL_TIME','TASK_TYPE','VISIT_TYPE','ID','TASK_NUMBER'],
		fn:function(MGR_ID,CUST_NAME,MGR_NAME,INTERVIEWEE_NAME,INTERVIEWEE_POST,INTERVIEWEE_PHONE,VISIT_TIME,CALL_TIME,TASK_TYPE,VISIT_TYPE,ID,TASK_NUMBER){
			MGR_ID.hidden = true;
			TASK_TYPE.hidden = true;
			TASK_NUMBER.hidden = true;
			ID.hidden = true;
			...
			return [MGR_ID,CUST_NAME,MGR_NAME,INTERVIEWEE_NAME,INTERVIEWEE_POST,INTERVIEWEE_PHONE,VISIT_TIME,TASK_TYPE,VISIT_TYPE,ID,TASK_NUMBER,CALL_TIME];
		}
	},{
		   columnCount : 0.95,
		   fields:[{name:'JOIN_PERSON',text:'本次参与人员',xtype:'textarea'}],
		   fn:function(JOIN_PERSON){
		...
		columnCount : 2,
		fields:['CUS_DOMICILE','CUS_NATURE','CUS_LEGALPERSON','CUS_REGTIME','CUS_CNTPEOPLE','CUS_ONMARK','CUS_ONMARKPLACE','CUS_OWNBUSI','CUS_BUSISTATUS',
		        'CUS_OPERATEPERSON','CUS_ACCOUNTPERSON','CUS_MAJORPRODUCT','CUS_MAJORRIVAL','ID','TASK_NUMBER','MARK_RESULT_OLD','MARK_REFUSEREASON_OLD'],
		fn:function(CUS_DOMICILE,CUS_NATURE,CUS_LEGALPERSON,CUS_REGTIME,CUS_CNTPEOPLE,CUS_ONMARK,CUS_ONMARKPLACE,CUS_OWNBUSI,CUS_BUSISTATUS,
		        CUS_OPERATEPERSON,CUS_ACCOUNTPERSON,CUS_MAJORPRODUCT,CUS_MAJORRIVAL,ID,TASK_NUMBER,MARK_RESULT_OLD,MARK_REFUSEREASON_OLD){
				ID.hidden = true;
				TASK_NUMBER.hidden = true;
				MARK_RESULT_OLD.hidden = true;
				MARK_REFUSEREASON_OLD.hidden = true;
				
				CUS_DOMICILE.readOnly = true;CUS_NATURE.readOnly = true;CUS_LEGALPERSON.readOnly = true;CUS_REGTIME.readOnly = true;
				CUS_CNTPEOPLE.readOnly = true;CUS_ONMARK.readOnly = true;CUS_OWNBUSI.readOnly = true;CUS_BUSISTATUS.readOnly = true;
		        CUS_OPERATEPERSON.readOnly = true;CUS_ACCOUNTPERSON.readOnly = true;CUS_MAJORPRODUCT.readOnly = true;CUS_MAJORRIVAL.readOnly = true;
		        CUS_ONMARKPLACE.readOnly = true;CUS_ONMARKPLACE.cls = "x-readOnly";
		        CUS_DOMICILE.cls = "x-readOnly";CUS_NATURE.cls = "x-readOnly";CUS_LEGALPERSON.cls = "x-readOnly";CUS_REGTIME.cls = "x-readOnly";
		        CUS_CNTPEOPLE.cls = "x-readOnly";CUS_ONMARK.cls = "x-readOnly";CUS_OWNBUSI.cls = "x-readOnly";CUS_BUSISTATUS.cls = "x-readOnly";
		        CUS_OPERATEPERSON.cls = "x-readOnly";CUS_ACCOUNTPERSON.cls = "x-readOnly";CUS_MAJORPRODUCT.cls = "x-readOnly";CUS_MAJORRIVAL.cls = "x-readOnly";
			return [CUS_DOMICILE,CUS_NATURE,CUS_LEGALPERSON,CUS_REGTIME,CUS_CNTPEOPLE,CUS_ONMARK,CUS_ONMARKPLACE,CUS_OWNBUSI,CUS_BUSISTATUS,
			        CUS_OPERATEPERSON,CUS_ACCOUNTPERSON,CUS_MAJORPRODUCT,CUS_MAJORRIVAL,ID,TASK_NUMBER,MARK_RESULT_OLD,MARK_REFUSEREASON_OLD];
		}
	},{
		columnCount:0.945,
		...
		fields : ['TEST'],
		fn : function(TEST){
			return [newPanel_1_detail];//主要股东及持股比列
		}
	},{
		columnCount:0.945,
		...
		fields : ['TEST'],
		fn : function(TEST){
			return [newPanel_10_detail];//拟申请授信产品
		}
	},{
		columnCount:0.945,
		...
		columnCount : 2,
		fields:['RES_CUSTSOURCE','RES_CASEBYPERSON','RES_CASEBYPTEL','ID','TASK_NUMBER'],
		fn:function(RES_CUSTSOURCE,RES_CASEBYPERSON,RES_CASEBYPTEL,ID,TASK_NUMBER){
			ID.hidden = true;
			TASK_NUMBER.hidden = true;
			...
			return [RES_CUSTSOURCE,RES_CASEBYPERSON,RES_CASEBYPTEL,ID,TASK_NUMBER];
		}
	},{
		   columnCount : 0.95,
		   fields:['RES_FOLLOWUP'],
		...
		columnCount : 2,
		fields:['MARK_RESULT','MARK_REFUSEREASON','CALL_SPENDTIME',
		        'CALL_NEXTTIME','ID','TASK_NUMBER'],
		fn:function(MARK_RESULT,MARK_REFUSEREASON,CALL_SPENDTIME,
		        CALL_NEXTTIME,ID,TASK_NUMBER){
			ID.hidden = true;
			TASK_NUMBER.hidden = true;
			...
			return [MARK_RESULT,MARK_REFUSEREASON,CALL_SPENDTIME,
			        CALL_NEXTTIME,ID,TASK_NUMBER];
		}
	}]
},{
...
},
{
	...
	groups : [{
		columnCount : 2,
		fields:['MGR_ID',{name:'CUST_NAME',text:'客户名称',xtype:'customerqueryqz',hiddenName:'CUST_ID',allowBlank:false,custType:'1',
		...
		}},'MGR_NAME','INTERVIEWEE_NAME','INTERVIEWEE_POST','INTERVIEWEE_PHONE','VISIT_TIME','CALL_TIME','TASK_TYPE','VISIT_TYPE','ID','TASK_NUMBER'],
		fn:function(MGR_ID,CUST_NAME,MGR_NAME,INTERVIEWEE_NAME,INTERVIEWEE_POST,INTERVIEWEE_PHONE,VISIT_TIME,CALL_TIME,TASK_TYPE,VISIT_TYPE,ID,TASK_NUMBER){
			MGR_ID.hidden = true;
			TASK_TYPE.hidden = true;
			TASK_NUMBER.hidden = true;
...
//			VISIT_TYPE.cls = "x-readOnly";
		...
		columnCount : 2,
		fields:['CUS_DOMICILE','CUS_NATURE','CUS_LEGALPERSON','CUS_REGTIME','CUS_CNTPEOPLE',
		...
		columnCount : 2,
		fields:[{name:'MARK_RESULT',text:'拜访结果',editable:true,translateType:'VISIT_RESULT_QS',listeners:{
	    		select:function(combo,record){
		    			var v = this.getValue();
		    			if(v=='3'){
	    	...
	    	}},'MARK_REFUSEREASON','CALL_SPENDTIME',
		        'CALL_NEXTTIME','ID','TASK_NUMBER','NEW_RECORD_ID','FLAG','CONCLUSION'],
		fn:function(MARK_RESULT,MARK_REFUSEREASON,CALL_SPENDTIME,
		        CALL_NEXTTIME,ID,TASK_NUMBER,NEW_RECORD_ID,FLAG,CONCLUSION){
			ID.hidden = true;
			TASK_NUMBER.hidden = true;
...
//        	   }
		...
		fn : function(formPanel,basicForm){
	       ...
	       if( task_type==1 && conclusion!=4 ){
	       	   Ext.MessageBox.alert('提示','该客户未通过客户筛选,不允许提交CALLREPORT');
	               return false;
	       }
           if(value == '3'){
        	   if(formPanel.form.findField("MARK_REFUSEREASON").getValue() == '' || formPanel.form.findField("MARK_REFUSEREASON").getValue() == null){
...
//						Ext.Msg.alert('提示',"操作成功!");
	...
	fields : [	
			...
			fn : function(ID,TASK_NUMBER,F_HTYPE,F_OTYPE,F_AREA,F_UTYPE,F_ASSESS){
				return [ID,TASK_NUMBER,F_HTYPE,F_OTYPE,F_AREA,F_UTYPE,F_ASSESS];
			}
	},{
		   columnCount : 1,
...
//						Ext.Msg.alert('提示',"操作成功!");
	...
	fields : [	
			...
			fn : function(ID,TASK_NUMBER,D_BANKNAME,D_AVGDEPOSIT){
				return [ID,TASK_NUMBER,D_BANKNAME,D_AVGDEPOSIT];
			}
	}],
	formButtons:[{
		text : '保存并继续增加',
...
//						Ext.Msg.alert('提示',"操作成功!");
	...
	fields : [	
	            ...
	            {name : 'L_DBRATE',text  : '担保率(%)',hidden : false,vtype:'dbPercent',maxLength:20},
	            {name : 'L_COLLATERAL',text  : '担保品',hidden : false,maxLength:50}
				],
			fn : function(ID,TASK_NUMBER,L_BANKNAME,L_LIMITTYPE,L_LIMITMONEY,L_BALANCE,L_RATE,L_DBRATE,L_COLLATERAL){
				return [ID,TASK_NUMBER,L_BANKNAME,L_LIMITTYPE,L_LIMITMONEY,L_BALANCE,L_RATE,L_DBRATE,L_COLLATERAL];
			}
	},{
		   columnCount : 1,
...
//						Ext.Msg.alert('提示',"操作成功!");
	...
	fields : [	
	            ...
	            {name : 'DP_AVGDEPOSIT',text  : '预计平均存款量(人民币/千元)',hidden : false,vtype:'money',maxLength:20}
				],
...
//						Ext.Msg.alert('提示',"操作成功!");
	...
	fields : [	
	            ...
	            {name : 'FL_DEAL2MONTH',text  : '月交易量（等值美金/千元）',hidden : false,vtype:'money',maxLength:20},
	            {name : 'FL_LIMITMONEY',text  : '额度金额（等值美金/千元）',hidden : false,vtype:'money',maxLength:20}
				],
...
var viewshow = function(view){
	if(view._defaultTitle == '新增拟申请授信产品'){
		getCurrentView().contentPanel.getForm().findField('CP_PRODUCT').hide();
	}else if(view._defaultTitle == '补充CALLREPORT维护'){
...
var saveBaseValue = function(form){
	...
	temp.CUS_ONMARKPLACE = form.findField('CUS_ONMARKPLACE').getValue();
	...
	temp.TASK_TYPE = form.findField('TASK_TYPE').getValue();
	...
	temp.DCRB_FIXEDASSETS = form.findField('DCRB_FIXEDASSETS').getValue();
	temp.DCRB_PROFIT = form.findField('DCRB_PROFIT').getValue();
	temp.DCRB_SYMBIOSIS = form.findField('DCRB_SYMBIOSIS').getValue();
	temp.DCRB_OTHERTRADE = form.findField('DCRB_OTHERTRADE').getValue();
	temp.DCRB_MYSELFTRADE = form.findField('DCRB_MYSELFTRADE').getValue();
	
}
/**
 * 回填CALLREPORT维护页面部分数据
 * @param form
 * @returns
 */
var setBaseValue = function(form) {
	...
	form.findField('CUS_ONMARKPLACE').setValue(temp.CUS_ONMARKPLACE);
