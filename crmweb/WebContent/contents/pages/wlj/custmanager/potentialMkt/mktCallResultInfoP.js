/**
 * @description 个金客户营销流程 - 个金拜访结果汇总信息页面
 * @author luyy
 * @since 2014-07-27
 */
...
var url = basepath + '/mktCallResult.json?type=1';
...
var fields = [{name:'ORG_ID',text:'机构',xtype : 'wcombotree',innerTree:'ORGTREE',
              ...
              {name:'COLD_CALL',text:'COLD_CALL客户数',dataType:'numberNoDot',resutlWidth:90},
              {name:'COLD_PER',text:'COLD_CALL成功率',dataType:'string',resutlFloat:'right',resutlWidth:100},
              {name:'VISIT',text:'约访客户数',dataType:'numberNoDot',resutlWidth:90},
              {name:'NEW_VISIT',text:'约访新客户',dataType:'numberNoDot',resutlWidth:90},
              {name:'PIPELINE',text:'转入PIPELINE客户数',dataType:'numberNoDot',resutlWidth:90},
              {name:'PIPE_PER',text:'PIPELINE成功率',dataType:'string',resutlFloat:'right',resutlWidth:90}
			  ];

var customerView = [{
	title:'客户经理拜访任务',
	type:'grid',
	url:basepath + '/mktCallResult.json?type=3',
	frame : true,
	fields:{fields:[
