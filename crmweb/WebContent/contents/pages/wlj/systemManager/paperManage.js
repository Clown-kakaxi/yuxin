...
var questionCm = new Ext.grid.ColumnModel( [ rownum,{
	...
	renderer:function(value,record,e){
		...
		var sort;
		if(sortValue=='')
			sort = '<input id='+e.id+'sort  type="textfield" name="titlesort" onchange="judgeVal(this);"  style="display:none;" value='+sortValue+' >';
		else
			sort = '<input id='+e.id+'sort  type="textfield" name="titlesort" onchange="judgeVal(this);"  value='+sortValue+' >';
		return  sort;
	},
	width : 165,
	sortable : true
