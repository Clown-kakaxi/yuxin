...
var fields = [
    ...
    {name: 'SEX',text:'性别',  resutlWidth:80,translateType : 'DEM0100005'},
    {name: 'USER_STATE',text:'状态',  resutlWidth:80,translateType : 'SYS_USER_STATE'},
    {name: 'BELONG_BUSI_LINE',text:'归属业务条线',translateType : 'BUSI_LINE_TYPE',allowBlank: false},
    {name: 'BELONG_TEAM_HEAD',text:'归属Team Head',xtype : 'userchoose',hiddenName:'BELONG_TEAM_HEAD',allowBlank: false},
