 ...
 * 交易异常js
 */
var url = basepath+"/txErrAction.json";//交易日志查询
var lookupTypes = [{
	TYPE : 'LOOKUP_TYPE',
	url : '/txErrCodeAction.json',
	key : 'TX_CODE',
	value : 'TX_CODE',
	jsonRoot : 'json.data'
},{
	TYPE : 'LOOKUP_TYPE1',
	url : '/txErrCdAction.json',
	key : 'SRC_SYS_CD',
	value : 'SRC_SYS_CD',
	jsonRoot : 'json.data'
}];
...
var fields = [
	            {name: 'TX_ERR_ID', text : '交易异常标识', resutlWidth:20,hidden:true},
	  		    ...
	  		    {name : 'TX_DT',xtype : 'datefield',format:'Y-m-d',text : '交易日期',dataType : 'date',searchField:true,allowBlank:false,resutlWidth:80},
