...
<head>
	...
	var tabs =[{
		title:'存款账号信息',
		url:'/contents/pages/wlj/customerManager/customerGroup/groupAccountInfoDeposit.js'
	},{
		title:'贷款账号信息',
		url:'/contents/pages/wlj/customerManager/customerGroup/groupAccountInfoLoan.js'
	}];
	</script>
