...
var fields=[
//            {name:'MKT_TEAM_ID',text:'营销团队编号',searchField:false,resutlWidth:80,allowBlank: false}, 
...
//           {name:'USER_NAME',text:'客户经理名称',searchField:true,translateType : 'DPTTYPE'},
//            {name:'USER_ID',text:'客户经理编号',xtype:'textfield',searchField:false},
            {name:'USER_ID',text:'客户经理编号',xtype:'textfield',searchField:false,hidden:true},
            {name:'TIME',text:'时间',searchField:false,resutlFloat:'right',dataType:'date',xtype:'datefield',format:'Y-m'},
//            {name:'TIME',text:'时间',searchField:false,resutlFloat:'right'},
            ...
            {name:'SAVE_INCRE_MONTH',text:'存款时点增量本月目标总量',searchField:false,xtype:'textfield',gridField:false},
            {name:'SAVE_INCRE_SEASON',text:'存款时点增量本季目标总量',xtype:'textfield',searchField:false,gridField:false},
            {name:'SAVE_INCRE_YEAR',text:'存款时点增量本年目标总量',xtype:'textfield',resutlFloat:'right',searchField:false,gridField:false},
            {name:'LOAN_MONTH',text:'贷款动拨金额本月目标总量',xtype:'textfield',gridField:false},
            {name:'LAON_SEASON',text:'贷款动拨金额本季目标总量',xtype:'textfield',gridField:false},
            {name:'LOAN_YEAR',text:'贷款动拨金额本年目标总量',xtype:'textfield'},
            {name:'INSURANCE_SALE_MONTH',text:'保险销售额本月目标总量',xtype:'textfield',gridField:false},
            {name:'INSURANCE_SALE_SEASON',text:'保险销售额本季目标总量',xtype:'textfield',gridField:false},
            {name:'INSURANCE_SALE_YEAR',text:'保险销售额本年目标总量',xtype:'textfield',gridField:false}
            ];
/***
 * 新增
 */
...
var tbar = [{
	...
	handler : function(){
		if(getSelectedData() == false){
			...
			var id=getSelectedData().data.USER_ID;
			Ext.MessageBox.confirm('提示','确定删除吗?',function(buttonId){
				...
				Ext.Ajax.request({
//					url: basepath + '/customerMktTeamInformationAdd!batchDestroy.json?idStr='+id,
