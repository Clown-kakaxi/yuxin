...
var notesForm = new Ext.Panel({
	...
	autoHeight:true,
	padding:'10 20 0',
	html:'认购费用＝认购金额-认购金额/(1+认购费率)<br>净认购金额＝认购金额－认购费用<br>认购份数＝净认购金额/基金单位面值'
});
...
var inputForm = new Ext.FormPanel({
	...
	{xtype: 'numberfield',name: 'RATE',fieldLabel: '认购费率(%)<font color=red>*</font>',width: 180,allowBlank:false},
	{
	    columnWidth:1,
	    layout:'column',
	    padding:'5 115 0',
...
var outputForm = new Ext.FormPanel({
	...
	labelWidth:120,
	items:[
		{xtype: 'textfield',name: 'RESULT_MONEY1',fieldLabel: '认购费用(元)',width: 180,disabled:true},
		{xtype: 'textfield',name: 'RESULT_MONEY2',fieldLabel: '净认购金额(元)',width: 180,disabled:true},
		{xtype: 'textfield',name: 'RESULT_MONEY3',fieldLabel: '认购份数(份)',width: 180,disabled:true}
	]
});
