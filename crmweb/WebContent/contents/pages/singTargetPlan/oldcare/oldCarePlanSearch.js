Ext.onReady(function() {
	...
	var data = [
	            ['李晓丽养老规划','李晓丽','2013-08-26','2013-08-26','李晓丽房规划'],
	            ['李四养老规划','李四','2013-07-24','2013-08-26','李四养老规划'],
	            ['五XX养老规划','五XX','2013-08-26','2013-08-26','五XX养老规划'],
	            ['张XX养老规划','张XX','2013-07-26','2013-08-26','张XX养老规划'],
	            ['软三养老规划','软三','2013-11-25','2013-08-26','软三养老规划']
				...
				items : [ {
					...
					items : [
							...
							},
							{
								...
								id : 'center-panel',
								title : "",
								html : '<iframe src="info1.jsp" frameborder="0" scrolling="yes" id="blocViewFrame" name="blocViewFrame" width="100%" height="100%"></iframe>'
							} ]
				} ]
			});
