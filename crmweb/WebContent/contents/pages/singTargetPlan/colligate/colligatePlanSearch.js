Ext.onReady(function() {
	...
	var data = [
	            ['王一平综合规划','王一平','2013-08-26','2013-08-26','王一平房规划'],
	            ['李丽娟综合规划','李丽娟','2013-07-24','2013-08-26','李丽娟综合规划'],
	            ['张馨予综合规划','张馨予','2013-08-26','2013-08-26','张馨予综合规划'],
	            ['周鑫综合规划','周鑫','2013-07-26','2013-08-26','周鑫综合规划'],
	            ['刘莎莎综合规划','刘莎莎','2013-11-25','2013-08-26','刘莎莎综合规划']
				...
				items : [ {
					...
					items : [
							...
							},
							{
								...
								id : 'center-panel',
								title : "",
								html : '<iframe src="../investPlan/planCreate.jsp" frameborder="0" scrolling="yes" id="blocViewFrame" name="blocViewFrame" width="100%" height="100%"></iframe>'
							} ]
				} ]
			});
