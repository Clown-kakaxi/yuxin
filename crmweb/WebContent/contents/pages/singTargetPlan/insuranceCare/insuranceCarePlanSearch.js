Ext.onReady(function() {
	...
	var data = [
	            ['李晓丽保险规划','李晓丽','2013-08-26','2013-08-26','李晓丽房规划'],
	            ['李四保险规划','李四','2013-07-24','2013-08-26','李四保险规划'],
	            ['五XX保险规划','五XX','2013-08-26','2013-08-26','五XX保险规划'],
	            ['张XX保险规划','张XX','2013-07-26','2013-08-26','张XX保险规划'],
	            ['软三保险规划','软三','2013-11-25','2013-08-26','软三保险规划']
				...
				items : [ {
					...
					items : [
							...
							},
							{
								...
								id : 'center-panel',
								title : "",
								html : '<iframe src="oldinfo.jsp" frameborder="0" scrolling="yes" id="blocViewFrame" name="blocViewFrame" width="100%" height="100%"></iframe>'
							} ]
				} ]
			});
