...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/system/moduleManager/moduleManager.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/system/moduleManager/functionManager.js"></script>
