	    ...
	    items : [{
	    	...
	    	items : [{
	    		...
	    		items : [
					...
					{xtype : 'datefield',name : 'workInterfixDt',format : 'Y-m-d',fieldLabel : '客户移交生效日期',labelStyle : 'text-align:right;',readOnly:true,anchor : '95%'}
	           	]
	    	},{
	    		layout : 'form',
	    		columnWidth : 1,
	    		labelWidth:100,
	    		items : [ 
	    			{name : 'handOverReason',xtype : 'textarea',fieldLabel : '考核指标移转',labelStyle : 'text-align:right;',anchor : '97.5%'}
	    		]
	    	}]
	    }]
	});
