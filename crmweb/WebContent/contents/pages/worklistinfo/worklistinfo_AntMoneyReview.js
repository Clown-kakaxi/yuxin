...
Ext.onReady(function() {
	...
	*/
    ...
    var store = new Ext.data.Store({
        ...
        proxy : new Ext.data.HttpProxy(
        		{
        			url:basepath+'/antMoneyReview.json?CUST_ID='+id+'&CUST_GRADE='+custGrade +'&instanceid='+instanceid 
        		}),
        reader: new Ext.data.JsonReader({
        	root : 'json.data'
        }, [
...
//													mode : 'local',forceSelection : true,readOnly:true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
											      ...
											      ,{xtype : 'combo',name : 'FXQ023',fieldLabel : '客户的股权或控制权结构',store : zlFXQ023Store,resizable : true,valueField : 'key',displayField : 'value',
													mode : 'local',forceSelection : true,readOnly:true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
										        ,{xtype : 'combo',name : 'CUST_GRADE',fieldLabel : '系统预评等级',store : riskgradeStore,resizable : true,valueField : 'key',displayField : 'value',
													mode : 'local',forceSelection : true,readOnly:true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
										        ,{name : 'CUST_GRADE_FP', fieldLabel : '复评等级',readOnly:true,cls:'x-readOnly',anchor : '90%',xtype: 'combo',store : riskgradeStore,resizable : true,valueField : 'key',displayField : 'value',
													mode : 'local',forceSelection : true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
...
//										                 
										        ...
										        ,{xtype : 'combo',name : 'CUST_GRADE',fieldLabel : '系统预评',store : riskgradeStore,resizable : true,valueField : 'key',displayField : 'value',
													mode : 'local',forceSelection : true,readOnly:true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
										    	,{name : 'CUST_GRADE_FP', fieldLabel : '复评等级',readOnly:true,cls:'x-readOnly',anchor : '90%',xtype: 'combo',store : riskgradeStore,resizable : true,valueField : 'key',displayField : 'value',
													mode : 'local',forceSelection : true,readOnly:true,cls:'x-readOnly',triggerAction : 'all',anchor : '90%'}
	  ...
	  //********************打印预览开始*************************
	    var printPerHis = function() {
	        ...
	        turl +=
	        	...
	        	//'&DQSH024='+cond.DQSH024+	//客户是否涉及反洗钱黑名单
	        ...
	        tempApp.openWindow({
	            ...
	            +'/contents/pages/wlj/custmanager/antiMoney/printManager/printAntMoneyReview.jsp'
	                    + turl,
	            resId : 'task_print_1',
	            id : 'task_print_1',
	            serviceObject : false
	    ...
	    var printORGHis = function() {
	        ...
	        turl +=
	        	...
	        	//'&DQSH024='+cond.DQSH024+	//DQSH024	客户是否涉及反洗钱黑名单
	        ...
	        tempApp.openWindow({
	            name : '打印预览',
	            action : basepath
	            +'/contents/pages/wlj/custmanager/antiMoney/printManager/printAntMoneyReviewORG.jsp'
	                    + turl,
	            resId : 'task_print_1',
	            id : 'task_print_1',
	            serviceObject : false
