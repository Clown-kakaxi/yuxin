...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/systemManager/menuManages/iconData.js"></script>
		
		<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/systemManager/menuManages/menuManagesWithNew.js"></script>
	</head>
	<body>
	</body>
</html>