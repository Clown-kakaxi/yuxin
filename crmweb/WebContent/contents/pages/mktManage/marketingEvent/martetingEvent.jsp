...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/marketingEvent/marketRelatProduct.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/marketingEvent/marketRelatCustomer.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/marketingEvent/marketingEvent.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/marketingEvent/creatingMktActivity.js"></script>
