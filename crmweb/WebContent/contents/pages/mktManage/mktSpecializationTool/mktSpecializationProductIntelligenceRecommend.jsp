...
<%@ page import="com.yuchengtech.bob.core.CustBelongParamManager" language="java" %>
<html>
...
<script type="text/javascript"src="<%=request.getContextPath()%>/contents/pages/mktManage/mktSpecializationTool/mktSpecializationProductIntelligenceRecommendDefine.js"></script>
<script type="text/javascript"src="<%=request.getContextPath()%>/contents/pages/mktManage/mktSpecializationTool/mktSpecializationProductIntelligenceRecommend.js"></script>
