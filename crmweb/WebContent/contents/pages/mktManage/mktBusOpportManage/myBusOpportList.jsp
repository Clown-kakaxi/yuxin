...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportQueryCondition.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportTable.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportList.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportSalesActiv.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportClose.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/contents/pages/mktManage/mktBusOpportManage/myBusOpportReturn.js"></script>
