...
<script type="text/javascript"src="<%=request.getContextPath()%>/contents/pages/mktManage/mktActivityFeedback/mktActivityManegerback.js"></script>

</head>
<body>
<body>

<input id='ActiIdStr' type='hidden'/>
<input id='myActiIdStr' type='hidden'/>
<input id='exeStr' type='hidden'/>
</body>
</body>
</html>