...
<head>
	...
	<version:frameScript type="text/javascript" src="/contents/frameControllers/view/Wlj-conncallreportview-base.js"/>
</head>
<script type="text/javascript">
	<%
		String acceptBtn = request.getParameter("acceptBtn");
		out.print("var _acceptBtn = "+acceptBtn+";");
		String rejectBtn = request.getParameter("rejectBtn");
		out.print("var _rejectBtn = "+rejectBtn+";");
	%>
</script>
<body>
</body>
