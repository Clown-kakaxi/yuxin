...
$(document).ready(function() {
	function t(t) {
		for (var n = "", a = 0, i = EXAMPLES.length; i > a; ++a) EXAMPLES[a].type === t && (n += '<li><a href="CustomerAnalysisChart.jsp#' + EXAMPLES[a].id + '"><img src="' + GALLERY_THUMB_PATH + EXAMPLES[a].id + '.png"></a></li>');
	...
	var i = $("#left-chart-nav ul"),
		o = location.pathname.match(/CustomerAnalysisChart.jsp/);
