...
/**
 * @describtion: 对公客户信息第二页(发生日期)工作流动态调用处理类
 * @author : sunjing5
 * @date : 2017-06-26
 */
public class ComSecond2 extends EChainCallbackCommon{
	...
	public void endY(EVO vo,String custId,String updateFlag,AuthUser auth) {
		try {
			String stockSql=" T.update_Table = 'ACRM_F_CI_ORG_ISSUESTOCK'";
			addTrans(vo,custId,updateFlag,auth,stockSql);
