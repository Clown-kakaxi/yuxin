...
/**
 * @describtion: 客户视图-对公基本信息工作流动态调用处理类
 *
 * @author : 
 * @date : 
 * @update 20140925,helin,增加CRM业务更新操作实现
 */
public class PuBaseIC extends EChainCallbackCommon {
	
	private static Logger log = Logger.getLogger(PuBaseIC.class);

	/**
	 * 审批处理拒绝处理方法
	 * 如果拒绝，则从审批记录表【OCRM_F_CI_CUSTINFO_UPHIS】中删除记录
	 * @param vo
	 */
