...
/**
 * @describtion: 对公授信信息工作流动态调用处理类
 *
 * @author : 
 * @date : 
 * @update 20140924,helin,增加CRM业务更新操作实现
 */
public class OrgSxInfo extends EChainCallbackCommon{
	
	private static Logger log = Logger.getLogger(OrgSxInfo.class);
	...
	public void endY(EVO vo) {
		try {
			...
			SQL="select update_af_cont,update_item_en,update_table,update_user from OCRM_F_CI_CUSTINFO_UPHIS where cust_id='"+custId+"' and update_flag='"+updateFlag+"' ORDER BY UPDATE_TABLE";
			//调用交易接口
