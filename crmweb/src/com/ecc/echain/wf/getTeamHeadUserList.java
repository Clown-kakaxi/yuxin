...
public class getTeamHeadUserList implements NodeUserListExtIF{
	...
	public List getNodeUserList(EVO vo) throws Exception {
		...
		//获得流程变量值
		String sql = " select a.belong_team_head from admin_auth_account a  where account_name=(select t.mgr_id from Ocrm_f_Interview_Record t where t.task_number='"+batch_no+"')";
