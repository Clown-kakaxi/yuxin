 ...
 * @date : 
 */
public class XmlTableUtil extends EChainCallbackCommon{
	...
	public boolean checkTable(String tableName) throws Exception{
		String[] str={"ACRM_F_CI_ADDRESS","ACRM_F_CI_CUST_IDENTIFIER","ACRM_F_CI_CUST_IDENTIFIER1","ACRM_F_CI_CUST_IDENTIFIER2","ACRM_F_CI_CONTMETH","ACRM_F_CI_CUSTOMER",
                      "ACRM_F_CI_PERSON","ACRM_F_CI_ORG","ACRM_F_CI_ORG_EXECUTIVEINFO","OCRM_F_CI_BELONG_CUSTMGR","OCRM_F_CI_BELONG_ORG","ACRM_F_CI_SPECIALLIST","ACRM_F_CI_PER_KEYFLAG"};
		for(String strs:str){
