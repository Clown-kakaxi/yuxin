...
@Action("/cust_bel_custmgr_info")
	public class CustBelCustmgrInfoAction extends CommonAction {
		...
		public void prepare() {
	        ...
	        if(request.getParameter("org_id")!=null){
	        	if("DB2".equals(SystemConstance.DB_TYPE)){
	        		sb.append (" and t.institution IN (SELECT a.UNITID FROM SYS_UNITS a,SYS_UNITS b WHERE  b.UNITID='"+request.getParameter("org_id")+"' and locate(b.UNITSEQ,a.UNITSEQ)>0)");
