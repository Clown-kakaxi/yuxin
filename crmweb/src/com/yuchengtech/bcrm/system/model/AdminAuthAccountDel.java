 ...
 */
@Entity
@Table(name="ADMIN_AUTH_ACCOUNT_DEL")
public class AdminAuthAccountDel implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ADMIN_AUTH_ACCOUNT_DEL_ID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize = 1)
