...
@Action(value="/custMgrVipCustomerAveAumDetail", results={
    @Result(name="success", type="json"),
})
public class custMgrVipCustomerAveDetailAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_AUM_DETAIL ci where  CUST_MANAGER_ID IS NOT NULL" );
