...
@Action(value="/branchVipCustzbqkSum", results={
    @Result(name="success", type="json"),
})
public class branchVipCustzbqkSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_NUM_RATE_COUNT ci where ci.ORG_ID4 IS NULL" );
