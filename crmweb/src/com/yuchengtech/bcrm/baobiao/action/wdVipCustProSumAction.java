...
@Action(value="/wdVipCustProSum", results={
    @Result(name="success", type="json"),
})
public class wdVipCustProSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("SELECT A.MONTH,A.ORG_NAME2,A.ORG_ID2,A.ORG_NAME4,A.ORG_ID4," +
        		...
        		" FROM ACRM_M_VIP_PROD_HAVING_RATE A WHERE A.CUST_MANAGER_ID IS NULL and org_id4 is not null"  );
