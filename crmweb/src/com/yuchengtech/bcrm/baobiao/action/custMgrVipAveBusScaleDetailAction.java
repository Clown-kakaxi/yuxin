...
@Action(value="/custMgrVipAveBusScaleDetail", results={
    @Result(name="success", type="json"),
})
public class custMgrVipAveBusScaleDetailAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_BUSI_SCALE_DETAIL ci where CUST_MANAGER_ID IS NOT NULL" );
