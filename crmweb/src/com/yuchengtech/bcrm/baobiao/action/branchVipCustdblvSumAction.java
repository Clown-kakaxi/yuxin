...
@Action(value="/branchVipCustdblvSum", results={
    @Result(name="success", type="json"),
})
public class branchVipCustdblvSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_STANDARD_RATE ci where ci.ORG_ID4 IS NULL" );
