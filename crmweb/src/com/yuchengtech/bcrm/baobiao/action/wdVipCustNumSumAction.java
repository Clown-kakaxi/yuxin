...
@Action(value="/wdVipCustzbqkSum", results={
    @Result(name="success", type="json"),
})
public class wdVipCustNumSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_NUM_RATE_COUNT ci where CUST_MANAGER_ID IS NULL and org_id4 is not null " );
