...
@Action(value="/custMgrVipCustNumSum", results={
    @Result(name="success", type="json"),
})
public class custMgrVipCustzbqkSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_NUM_COUNT ci where CUST_MANAGER_ID IS NOT NULL" );
