...
@Action(value="/wdVipCustomerAveSum", results={
    @Result(name="success", type="json"),
})
public class wdVipCustomerAveSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_AUM_COUNT ci where  CUST_MANAGER_ID IS NULL and ORG_ID4 IS not NULL" );
