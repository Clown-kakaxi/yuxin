...
@Action(value="/branchVipAveBusScaleSum", results={
    @Result(name="success", type="json"),
})
public class branchVipAveBusScaleSumAction extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")	
	private DataSource dsOracle;   
 	public void prepare() {
		// TODO Auto-generated method stub
        StringBuilder sb = new StringBuilder("select ci.* from ACRM_M_VIP_BUSI_SCALE_COUNT ci where ORG_ID4 IS NULL" );
