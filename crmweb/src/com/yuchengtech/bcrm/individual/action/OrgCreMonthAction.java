 ...
 */
@Action("/orgCreMonth")
public class OrgCreMonthAction extends CommonAction{
	...
	public void prepare(){
		...
		SQL ="SELECT T.COUNT_YEAR,T.COUNT_MONTH, ROUND(COALESCE(SUM(T.CRE_BAL),0)/10000,2) AS CRE_BAL, ROUND(COALESCE(SUM(T.CRE_YEAR_AVG),0)/10000,2) AS CRE_YEAR_AVG  FROM ACRM_F_CI_ORG_CRE_MONTH T "
	...
	//	fcbo.addAttribute("caption", "机构贷款趋势图");
