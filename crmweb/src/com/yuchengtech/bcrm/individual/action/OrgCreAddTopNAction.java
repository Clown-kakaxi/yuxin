...
/**
 * @describtion: 机构贷款客户增长TOP10
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月26日 下午5:48:13
 */
@Action("/orgCreAddTopN")
public class OrgCreAddTopNAction extends CommonAction{
	...
	public void prepare() {
		...
		SQL = "SELECT * FROM (SELECT T.CUST_ID, T.CUST_NAME, T.ODS_DATE, SUM(T.CRE_BAL) AS BAL FROM ACRM_F_CI_ORG_CRE_ADD_TOP T "
