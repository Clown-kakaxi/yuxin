...
/**
 * @describtion: 机构TOP10资金净流入客户
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月18日 上午11:37:13
 */
@Action("/orgCustIncomeTopN")
public class OrgCustIncomeTopNAction extends CommonAction{
	...
	public void prepare() {
		...
		SQL = "SELECT * FROM (SELECT T.CUST_ID, T.CUST_NAME, T.ODS_DATE, SUM(T.BAL) AS BAL FROM ACRM_F_CI_INCOME_TOP T "
