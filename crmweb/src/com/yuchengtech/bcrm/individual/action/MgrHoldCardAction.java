...
/**
 * @describtion: 客户经理持有贵宾卡客户
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月25日 上午9:14:13
 */
@Action("/mgrHoldCard")
public class MgrHoldCardAction extends CommonAction {
	...
	public void prepare() {
		...
		SQL = "select t.card_type,sum(t.CARD_NUM) as CARD_NUM from ACRM_F_CI_MGR_HOLD_CARD t where t.mgr_id = '"+auth.getUserId()+"'"
