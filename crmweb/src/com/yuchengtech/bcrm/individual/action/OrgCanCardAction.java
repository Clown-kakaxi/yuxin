...
/**
 * @describtion: 机构可发贵宾卡客户
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月25日 上午9:14:13
 */
@Action("/orgCanCard")
public class OrgCanCardAction extends CommonAction {
	...
	public void prepare() {
		...
		SQL = "select t.card_type,sum(t.CARD_NUM) as CARD_NUM from ACRM_F_CI_ORG_CAN_CARD t where t.org_id in (SELECT SYSUNIT.UNITID FROM SYS_UNITS SYSUNIT WHERE SYSUNIT.UNITSEQ LIKE '"+auth.getUnitInfo().get("UNITSEQ")+"%')"
