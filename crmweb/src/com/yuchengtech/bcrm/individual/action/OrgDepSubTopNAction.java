...
/**
 * @describtion: 机构存款流出客户TOP10
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月26日 下午5:45:43
 */
@Action("/orgDepSubTopN")
public class OrgDepSubTopNAction extends CommonAction{
	...
	public void prepare() {
		...
		SQL = "SELECT * FROM (SELECT T.CUST_ID, T.CUST_NAME, T.ODS_DATE, SUM(T.DEP_BAL) AS BAL FROM ACRM_F_CI_ORG_DEP_SUB_TOP T "
