...
/**
 * @describtion: 机构存款客户TOP10
 *
 * @author : lhqheli (email: lhqheli@gmail.com)
 * @date : 2014年7月18日 上午11:37:13
 */
@Action("/orgCustDepTopN")
public class OrgCustDepTopNAction extends CommonAction{
	...
	public void prepare() {
		...
		SQL = "SELECT * FROM (SELECT T.CUST_ID, T.CUST_NAME, T.ODS_DATE, SUM(T.DEP_BAL) AS BAL FROM ACRM_F_CI_DEP_TOP T "
