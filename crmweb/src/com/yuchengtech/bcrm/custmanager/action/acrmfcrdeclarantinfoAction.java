...
import com.yuchengtech.bcrm.custmanager.service.RelateInfoService;
 ...
 * 关联方的新增修改
 */
@Action("/acrmfcrdeclarantinfo")
public class acrmfcrdeclarantinfoAction extends CommonAction {
private static final long serialVersionUID = 1L;
    ...
    public void init(){
        ...
        setCommonService(relateinfoservice);
    }
    public void prepare(){
    	 /**
         *  主申报人信息查询
      ...
      StringBuffer sb1 =new StringBuffer ("select t.* from ACRM_F_CR_DECLARANT_INFO t WHERE 1=1   "	);
  	  if(mainId != null&&mainId!=""){
  		sb1.append(" and t.mainId = '"+mainId+"'");
  	  }
    ...
    public Object updateCancelStat(){
        ...
        relateinfoservice.updcancelStat(id);
        return "success";
    }				
    public DefaultHttpHeaders saveData(){	
   	...
   	if(((AcrmFCrDeclarantInfo)model).getMainId()==0){//执行新增申报人
     	...
     	String id = metadataUtil.getId((AcrmFCrDeclarantInfo)model).toString();
    		...
    		relateinfoservice.updataData(((AcrmFCrDeclarantInfo)model));
    		return new DefaultHttpHeaders("success");
   	}
	}
