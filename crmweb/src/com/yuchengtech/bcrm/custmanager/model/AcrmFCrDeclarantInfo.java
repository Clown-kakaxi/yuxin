...
/**
 * The persistent class for the ACRM_F_CR_DECLARANT_INFO database table.
 * 主申报人（关联人）主表
 */
@Entity
@Table(name="ACRM_F_CR_DECLARANT_INFO")
public class AcrmFCrDeclarantInfo implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ACRM_F_CR_DECLARANT_INFO_MAINID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CR_DECLARANT_INFO_MAINID_GENERATOR")
	@Column(name="MAIN_ID")
	private long mainId;
