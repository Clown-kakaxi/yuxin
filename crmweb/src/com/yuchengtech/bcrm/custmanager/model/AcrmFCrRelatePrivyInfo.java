...
/**
 * The persistent class for the ACRM_F_CR_RELATE_PRIVY_INFO database table.
 * 关联人的关联方从表
 * 
 */
@Entity
@Table(name="ACRM_F_CR_RELATE_PRIVY_INFO")
public class AcrmFCrRelatePrivyInfo implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ACRM_F_CR_RELATE_PRIVY_INFO_RELATEID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CR_RELATE_PRIVY_INFO_RELATEID_GENERATOR")
