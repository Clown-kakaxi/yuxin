...
public class OcrmFCiCustinfoUphi implements Serializable {
	...
	@Column(name="UPDATE_PAGE_ITEM_EN")
	private String updatePageItemEn;
	...
	public String getUpdatePageItemEn() {
		return updatePageItemEn;
	}

	public void setUpdatePageItemEn(String updatePageItemEn) {
		this.updatePageItemEn = updatePageItemEn;
	}
