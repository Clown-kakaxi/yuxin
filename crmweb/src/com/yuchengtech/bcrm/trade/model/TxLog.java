...
public class TxLog implements Serializable {
	...
	@Id
	@SequenceGenerator(name="TX_LOG_TXLOGID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TX_LOG_TXLOGID_GENERATOR")
