package com.yuchengtech.bcrm.trade.model;
...
/**
 * The persistent class for the TX_ERR database table.
 * 
 */
@Entity
@Table(name="TX_ERR")
public class TxErr implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TX_ERR_TXERRID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TX_ERR_TXERRID_GENERATOR")
	@Column(name="TX_ERR_ID")
