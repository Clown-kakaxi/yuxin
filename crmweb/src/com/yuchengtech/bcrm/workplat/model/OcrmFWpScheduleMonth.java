...
/**
 * The persistent class for the OCRM_F_WP_SCHEDULE_MONTH database table.
 * 
 */
@Entity
@Table(name="OCRM_F_WP_SCHEDULE_MONTH")
public class OcrmFWpScheduleMonth implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="OCRM_F_WP_SCHEDULE_MONTH_WID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OCRM_F_WP_SCHEDULE_MONTH_WID_GENERATOR")
	@Column(name="W_ID")
	private Long wId;
