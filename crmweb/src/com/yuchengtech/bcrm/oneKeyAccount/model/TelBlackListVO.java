 ...
 *
 */
public class TelBlackListVO {
	
	private String jylsh;//交易流水号
	private String jydm = "100501";//交易代码
	private String jyjg = "0000";//交易机构
	private String jygy;//交易柜员
	private String qdbs = "CRM";//渠道标识
	...
	private String ver = "2.5.5";//接口版本号

	private String mdlx = "200501";//名单类型
	private String sjlx = "IDType_IDNumber";//数据类型
