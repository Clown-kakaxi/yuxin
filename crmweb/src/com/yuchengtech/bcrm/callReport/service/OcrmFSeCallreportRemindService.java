 ...
 */
@Service
public class OcrmFSeCallreportRemindService extends CommonService {
	
	public OcrmFSeCallreportRemindService(){
		JPABaseDAO<OcrmFSeCallreportRemind,Long> baseDao = new JPABaseDAO<OcrmFSeCallreportRemind,Long>(OcrmFSeCallreportRemind.class);
		super.setBaseDAO(baseDao);
	}
	public Object save(Object obj){
		OcrmFSeCallreportRemind busi = (OcrmFSeCallreportRemind)obj;
