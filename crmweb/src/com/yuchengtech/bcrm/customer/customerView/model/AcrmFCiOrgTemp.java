...
/**
 * The persistent class for the ACRM_F_CI_ORG_TEMP database table.
 * 机构客户临时表
 */
@Entity
@Table(name="ACRM_F_CI_ORG_TEMP")
public class AcrmFCiOrgTemp implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ACRM_F_CI_ORG_TEMP_CUSTID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CI_ORG_TEMP_CUSTID_GENERATOR")
	@Column(name="CUST_ID")
    ...
    @Temporal( TemporalType.DATE)
	@Column(name="BUSI_START_TIME")
	private Date busiStartTime;
	...
	@Column(name="IN_BUSI_LINE")
	private String inBusiLine;
	...
	public String getInBusiLine() {
		return this.inBusiLine;
	}

	public void setInBusiLine(String inBusiLine) {
		this.inBusiLine = inBusiLine;
	}
