...
/**
 * The persistent class for the ACRM_F_CI_CUSTOMER database table.
 * 
 */
@Entity
...
public class AcrmFCiCustomer implements Serializable {
	...
	@Id
	@SequenceGenerator(name="ACRM_F_CI_CUSTOMER_ID_GENERATOR", sequenceName="ID_SEQUENCE")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CI_CUSTOMER_ID_GENERATOR")
	@Column(name="CUST_ID")
