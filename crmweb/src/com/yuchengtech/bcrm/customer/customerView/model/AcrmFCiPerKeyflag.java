...
public class AcrmFCiPerKeyflag implements Serializable {
	...
	@Column(name="IS_RELATED_BANK")
	private String isRealtedBank;
	...
	public String getIsRealtedBank() {
		return isRealtedBank;
	}

	public void setIsRealtedBank(String isRealtedBank) {
		this.isRealtedBank = isRealtedBank;
	}
