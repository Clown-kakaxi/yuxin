...
/**
 * The persistent class for the ACRM_F_CI_PERSON database table.
 * 
 */
@Entity
...
public class AcrmFCiPerson implements Serializable {
	...
	@Column(name="IF_REL_PERSON")
	private String ifRelPerson;
	@Column(name = "OTHER_CAREER")
	private String otherCareer;
	
	public String getIfRelPerson() {
		return ifRelPerson;
	}

	public void setIfRelPerson(String ifRelPerson) {
		this.ifRelPerson = ifRelPerson;
	}
