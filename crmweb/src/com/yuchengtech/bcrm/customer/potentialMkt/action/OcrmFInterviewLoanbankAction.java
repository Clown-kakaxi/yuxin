...
@Action("/ocrmFInterviewLoanbank")
public class OcrmFInterviewLoanbankAction  extends CommonAction{
	@Autowired
	@Qualifier("dsOracle")
	...
	public void prepare() {
    	...
    	String sqlapp = "select c.* from OCRM_F_INTERVIEW_LOANBANK c " +
    ...
    public void batchDel(){
    	...
    	for(String id : ids){
    		service.batchUpdateByName(" delete from OcrmFInterviewLoanbank g where g.id='"+Long.parseLong(id)+"'", null);
    	}
    }
}