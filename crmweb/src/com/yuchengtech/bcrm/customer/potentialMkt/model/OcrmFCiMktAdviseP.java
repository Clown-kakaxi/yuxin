...
/**
 * The persistent class for the OCRM_F_CI_MKT_ADVISE_P database table.
 * 
 */
@Entity
@Table(name="OCRM_F_CI_MKT_ADVISE_P")
public class OcrmFCiMktAdviseP implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="OCRM_F_CI_MKT_ADVISE_P_ID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OCRM_F_CI_MKT_ADVISE_P_ID_GENERATOR")
	private Long id;
