...
/**
 * The persistent class for the ACRM_F_CI_CUSTOMER_REVIEW database table.
 * 
 */
@Entity
@Table(name="ACRM_F_CI_CUSTOMER_REVIEW")
public class AcrmFCiCustomerReview implements Serializable {
