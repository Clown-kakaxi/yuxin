...
public class AcrmFCiAddress implements Serializable {
	...
	@Id
	@SequenceGenerator(name="ACRM_F_CI_ADDRESS_ID_GENERATOR", sequenceName="SEQ_ADDR_ID")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CI_ADDRESS_ID_GENERATOR")
	@Column(name="ADDR_ID")
	private long addrId;
