...
/**
 * The persistent class for the ACRM_F_CI_CUST_IDENTIFIER database table.
 * 
 */
@Entity
@Table(name="ACRM_F_CI_CUST_IDENTIFIER")
public class AcrmFCiCustIdentifier implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="ACRM_F_CI_CUST_IDENTIFIER_IDENT_ID_GENERATOR", sequenceName="ID_SEQUENCE" ,allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ACRM_F_CI_CUST_IDENTIFIER_IDENT_ID_GENERATOR")
	...
	@Column(name = "IDENT_COUNT")
	private int identCount;

	public AcrmFCiCustIdentifier() {
	}
	...
	public void setIdentCount(int identCount) {
