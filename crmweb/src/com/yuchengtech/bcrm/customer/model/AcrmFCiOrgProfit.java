...
/**
 * The persistent class for the ACRM_F_CI_ORG_PROFIT database table.
 * 
 */
@Entity
@Table(name="ACRM_F_CI_ORG_PROFIT")
public class AcrmFCiOrgProfit implements Serializable {
