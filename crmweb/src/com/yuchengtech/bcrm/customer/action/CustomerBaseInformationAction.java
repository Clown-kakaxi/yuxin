...
public class CustomerBaseInformationAction extends CommonAction{
 	...
 	public void prepare() {	
        ...
        if("true".equals(isNew)){
        	 sb.append("select  * from (select c.POTENTIAL_FLAG,c.source_channel,c.cust_id,c.cust_name,c.ident_type,c.ident_no,c.cust_type,c.cust_level,c.job_type,c.indust_type," +
             		...
             		" CASE WHEN CR.CUST_ID IS NULL THEN '0' ELSE '1' END AS IS_SX_CUST,'' as RECORD_SESSION " +
             ...
             sb.append(" union ");
             sb.append(" select '1' as POTENTIAL_FLAG,p.source_channel as source_channel,p.cus_id as cust_id,p.cus_name as cust_name,'' as ident_type,'' as ident_no,p.cust_type," +
             		  ...
             		  " '' as cust_stat, ao.org_name as org_name,ac.user_name as mgr_name,p.CUST_MGR as mgr_id,p.MAIN_BR_ID as org_id,'' as addr,'0' as IS_SX_CUST,p.record_session from ACRM_F_CI_POT_CUS_COM p " +
        	 ...
        	 sb.append("select c.POTENTIAL_FLAG,c.source_channel,c.cust_id,c.cust_name,c.ident_type,c.ident_no,c.cust_type,c.cust_level,c.job_type,c.indust_type," +
             		"c.linkman_name,c.linkman_tel,c.cust_stat,m.institution_name as org_name,m.mgr_name,m.mgr_id,m.INSTITUTION as org_id,d.addr,'' as RECORD_SESSION " +
