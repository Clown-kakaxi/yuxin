...
@Action("/workListDepositOutAction")
public class WorkListDepositOutAction extends CommonAction {
	...
	public void prepare() {
		...
		StringBuilder querySql = new StringBuilder(
				"SELECT A.ID, A.APPLY_NO, A.REGION, O.ORG_NAME,   A.CUST_TYPE,  A.IF_RE, A.CUST_ID, A.CUST_NAME,"+
						" A.DEP_OR_DRA,  A.ORG_ID,  O3.ORG_NAME AS ORG_NAME1,     "+
						" A.DEPOSIT_TYPE, A.CURRENCY,A.ESTIMATE_DATE, A.HAPPEN_REASON,    "+
